...
type EventType = "CameraPermissionCheck" | "CameraPermissionRequest" | "CameraPermissionUserResponse";

/** Ping type for ping.sdk.camera.permission */
export type PingCameraPermission = PingBase<"ping.sdk.camera.permission", "1.0.0", PingCameraPermissionData>;
