...
type WrapperProduct = "CrossplatformFlutter" | "CrossplatformReactNative" | "IdentityVerification";

/** Ping type for ping.sdk.wrapper.product */
export type PingWrapperProductInfo = PingBase<"ping.sdk.wrapper.product", "1.0.0", PingWrapperProductInfoData>;
