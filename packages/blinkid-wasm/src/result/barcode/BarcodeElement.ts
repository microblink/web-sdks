...
/**
 * BarcodeElementKey defines additional fields present in the barcode. Currently, this is only used for AAMVACompliant
 * documents.
 */
export type BarcodeElementKey =
  ...
  /**
   * Mandatory on all driver's licenses. All barcodes which are using 3-track magnetic stripe encoding used in the
   * interest of smoothing a transition from legacy documents shall be designated as "Magnetic". All barcodes which are
   * using compact encoding compliant with ISO/IEC 18013-2 shall be designated as "Compact". All barcodes (majority)
   * compliant with Mandatory PDF417 Bar Code of the American Association of Motor Vehicle Administrators (AAMVA) Card
   * Design Standard from AAMVA DL/ID-2000 standard to DL/ID-2013 shall be designated as "AAMVA".
   */
  | "document-type"
  ...
  /**
   * Mandatory on AAMVA 04, 05, 06, 07, 08 barcodes. Optional on AAMVA 01, 02, 03, Magnetic and Compact barcodes.
   *
  ...
  /**
   * Mandatory on AAMVA 02, 03, 04, 05, 06, 07, 08 and Magnetic barcodes. Optional and Compact barcodes.
   *
   ...
   * immediately after the IIN and the variable metadata structure in the PDF417 barcode data structure. for example:
   * ANSI 636010090002DL00410267ZF03080067DLDAQS1234567812300000000000000 ^^ | | | +-- SubField Designator (DL, ID, EN,
   * etc.) +----- IIN (636010)
   *
