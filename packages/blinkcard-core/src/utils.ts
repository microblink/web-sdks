...
import { BlinkCardScanningResult, ScanningSide } from "@microblink/blinkcard-wasm";
 ...
 */
export function extractSideInputImage(scanningResult: BlinkCardScanningResult, side: ScanningSide): ImageData | null {
  if (side === "first") {
