...
[@microblink/biometrics-core](../README.md) / CaptureFaceConfig
...
[`CaptureAnalysisResult`](CaptureAnalysisResult.md)
...
[`CaptureSessionState`](CaptureSessionState.md)
...
> `optional` **captureMode?**: [`CaptureMode`](CaptureMode.md)
