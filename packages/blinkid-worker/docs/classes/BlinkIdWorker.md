...
`Partial`\<\{ `barcodeModule`: `Partial`\<`BarcodeModuleSettings` \| `null`\>; `documentCaptureModule`: `Partial`\<`DocumentCaptureModuleSettings` \| `null`\>; `maxAllowedMismatchesPerField`: `number`; `mrzModule`: `Partial`\<`MrzModuleSettings` \| `null`\>; `vizModule`: `Partial`\<`VizModuleSettings` \| `null`\>; \}\>
