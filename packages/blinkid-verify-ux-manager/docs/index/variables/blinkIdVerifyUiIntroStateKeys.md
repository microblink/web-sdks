...
[@microblink/blinkid-verify-ux-manager](../../README.md) / [index](../README.md) / blinkIdVerifyUiIntroStateKeys

# Variable: blinkIdVerifyUiIntroStateKeys

> `const` **blinkIdVerifyUiIntroStateKeys**: readonly \[`"INTRO_FRONT_PAGE"`, `"INTRO_BACK_PAGE"`, `"INTRO_DATA_PAGE"`, `"INTRO_TOP_PAGE"`, `"INTRO_LEFT_PAGE"`, `"INTRO_RIGHT_PAGE"`, `"INTRO_LAST_PAGE"`\]
...
## See
 ...
 - `BlinkIdVerifyUiIntroStateKey` for the union type of these keys
