...
export default {
  ...
  feedback_messages: {
    ...
    keep_document_still: "Mantenha o celular imóvel",
    ...
    screen_detected: "Coloque o documento sobre um fundo liso",
  ...
  help_modal: {
    ...
    blur: {
      ...
      details_desktop: "Tente manter o dispositivo e o documento imóveis durante o escaneamento. Mover qualquer um deles pode desfocar a imagem e tornar os dados do documento ilegíveis.",
      title: "Mantenha-se imóvel durante a digitalização",
    },
    camera_lens: {
      details: "Verifique se a lente da câmera está limpa e sem poeira. Uma lente suja pode desfocar a imagem final, tornando os detalhes do documento ilegíveis e impedindo o escaneamento correto dos dados.",
