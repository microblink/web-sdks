...
export default {
  ...
  feedback_messages: {
    ...
    keep_document_still: "Hold enheten i ro",
    ...
    screen_detected: "Flytt dokumentet til en ensfarget bakgrunn",
  ...
  help_modal: {
    ...
    blur: {
      ...
      details_desktop: "Prøv å holde enheten og dokumentet i ro når du skanner. Bevegelse kan gjøre bildet uskarpt og føre til at dataene i dokumentet ikke kan leses.",
      title: "Stå i ro under skanningen",
    },
    camera_lens: {
      details: "Sjekk om det er støv eller flekker på kameralinsen. En skitten linse gjør at bildet blir uskarpt, noe som fører til at informasjonen i dokumentet blir uleselig og ikke skannes ordentlig.",
