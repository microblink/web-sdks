...
export default {
  ...
  feedback_messages: {
    ...
    keep_document_still: "A daina jijjigawa",
    ...
    screen_detected: "Matsar da takardar zuwa wurin da bayansa babu abubuwa",
  ...
  help_modal: {
    ...
    blur: {
      ...
      details_desktop: "A daina motsa na'ura da takarda yayin ɗaukar hoto. Motsa ɗaya daga cikinsu zai sa hoton ya yi dishi-dishi sannan zai sa ba za a iya karanta bayanan da suke kan takardar ba.",
      title: "Kada a motsa yayin ɗaukar hoto",
    },
    camera_lens: {
      details: "A duba domin tabbatar da gilashin kamerarku bai yi dishi-dishi ba, kuma ba ya ɗauke da ƙura. Gilashin kamera mai datti yakan sa hoton ya yi bishi-bishi, wanda hakan zai sa ba za a iya karanta bayanan da suke kan takardar ba sannan zai hana a ɗauki hoton bayanna yadda ya kamata.",
