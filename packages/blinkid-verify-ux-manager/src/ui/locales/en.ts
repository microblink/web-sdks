...
export default {
  ...
  help_modal: {
    ...
    blur: {
      ...
      details_desktop: "Try to keep the device and document still while scanning. Moving either can blur the image and make data on the document unreadable.",
      title: "Keep still while scanning",
    },
    camera_lens: {
      details: "Check your camera lens for smudges or dust. A dirty lens causes the final image to blur, making the document details unreadable and preventing successful scan of the data.",
