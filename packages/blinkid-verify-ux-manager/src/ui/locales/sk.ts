...
export default {
  ...
  feedback_messages: {
    ...
    keep_document_still: "Nehýbte sa",
    ...
    screen_detected: "Položte dokument na jednofarebné pozadie",
  ...
  help_modal: {
    ...
    blur: {
      ...
      details_desktop: "Počas skenovania by ste mali držať zariadenie a dokument v pokoji. Pohyb môže rozmazať obraz a spôsobiť, že údaje v dokumente budú nečitateľné.",
      title: "Počas snímania zostaňte v pokoji",
    },
    camera_lens: {
      details: "Skontrolujte, či na objektíve kamery nie sú šmuhy alebo prach. Ak je objektív znečistený, výsledný obraz bude rozmazaný, údaje na dokumente sa nebudú dať prečítať a skenovanie údajov sa nepodarí.",
