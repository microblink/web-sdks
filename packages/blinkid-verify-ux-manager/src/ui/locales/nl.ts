...
export default {
  ...
  feedback_messages: {
    ...
    keep_document_still: "Niet bewegen",
    ...
    screen_detected: "Leg het document op een egale achtergrond",
  ...
  help_modal: {
    ...
    blur: {
      ...
      details_desktop: "Probeer het toestel en het document tijdens het scannen stil te houden. Als u een van beide beweegt, kan de afbeelding wazig worden en kunnen gegevens op het document onleesbaar worden.",
      title: "Beweeg niet tijdens het scannen",
    },
    camera_lens: {
      details: "Controleer dat er geen vlekken of stof op de lens van uw camera zitten. Een vuile lens zorgt ervoor dat de uiteindelijke afbeelding wazig wordt, waardoor de documentgegevens onleesbaar worden en de gegevens niet goed kunnen worden gescand.",
