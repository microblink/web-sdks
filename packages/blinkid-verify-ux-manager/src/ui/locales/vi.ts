...
export default {
  ...
  feedback_messages: {
    ...
    screen_detected: "Đặt tài liệu trên nền trơn",
  ...
  help_modal: {
    ...
    blur: {
      ...
      details_desktop: "Cố gắng giữ yên thiết bị và tài liệu trong khi quét. Việc di chuyển có thể làm mờ hình ảnh và làm cho dữ liệu trên tài liệu không thể đọc được.",
      title: "Giữ cố định trong khi quét",
    },
    camera_lens: {
      details: "Kiểm tra ống kính camera xem có vết bẩn hoặc bụi không. Ống kính bẩn sẽ khiến hình ảnh cuối bị mờ, làm cho thông tin trên tài liệu không thể đọc được và ngăn cản việc quét dữ liệu thành công.",
