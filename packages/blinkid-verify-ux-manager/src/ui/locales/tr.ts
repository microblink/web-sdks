...
export default {
  ...
  feedback_messages: {
    ...
    keep_document_still: "Sabit tutun",
    move_closer: "Yaklaş",
    ...
    screen_detected: "Belgeyi sade bir arka plana yerleştirin",
  ...
  help_modal: {
    ...
    blur: {
      ...
      details_desktop: "Tarama sırasında cihazı ve belgeyi mümkün olduğunca sabit tutmaya çalışın. Herhangi birinin hareket etmesi görüntünün bulanıklaşmasına ve belge üzerindeki bilgilerin okunamamasına neden olabilir.",
      title: "Tarama sırasında hareketsiz kal",
    },
    camera_lens: {
      details: "Kamera lensinizin lekeli veya tozlu olup olmadığını kontrol edin. Lens kirliyse görüntü bulanık çıkar; bu da belge üzerindeki bilgilerin okunamamasına ve verilerin başarıyla taranamamasına yol açar.",
