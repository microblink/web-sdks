...
export default {
  ...
  feedback_messages: {
    ...
    keep_document_still: "No lo muevas",
    ...
    screen_detected: "Coloca el documento sobre un fondo liso",
  ...
  help_modal: {
    ...
    blur: {
      ...
      details_desktop: "Intente mantener el dispositivo y el documento quietos mientras escanea. Mover cualquiera de los dos puede difuminar la imagen y hacer que los datos del documento sean ilegibles.",
      title: "No se mueva mientras escanea",
    },
    camera_lens: {
      details: "Revisa que no haya manchas ni polvo en la lente de la cámara. Una lente sucia hace que la imagen final salga borrosa, lo que hace que los datos del documento sean ilegibles e impide escanear la información correctamente.",
