...
export default {
  ...
  feedback_messages: {
    ...
    keep_document_still: "Ostanite mirni",
    ...
    screen_detected: "Pomerite dokument na jednoličnu pozadinu",
  ...
  help_modal: {
    ...
    blur: {
      ...
      details_desktop: "Pokušajte da uređaj  i dokument budu mirni tokom skeniranja. Pomeranje bilo koje od njih može zamutiti sliku i učiniti podatke na dokumentu nečitljivim.",
      title: "Ostanite mirni dok skenirate",
    },
    camera_lens: {
      details: "Proverite da li na sočivu kamere ima mrlja ili prašine. Prljavo sočivo može zamutiti konačnu sliku, zbog čega detalji na dokumentu postaju nečitljivi i onemogućavaju uspešno skeniranje podataka.",
