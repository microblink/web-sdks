...
export default {
  ...
  feedback_messages: {
    ...
    keep_document_still: "Haltu kyrru",
    ...
    screen_detected: "Færðu skjalið að einföldum bakgrunni",
  ...
  help_modal: {
    ...
    blur: {
      ...
      details_desktop: "Reynið að halda tækinu og skjalinu kyrru meðan verið er að skanna. Ef annað hvort hreyfist getur myndin orðið óskýr og gögnin á skjalinu orðið ólæsileg.",
      title: "Verið kyrr á meðan skannað er",
    },
    camera_lens: {
      details: "Athugið hvort blettir eða ryk séu á myndavélalinsunni. Skítug linsa veldur því að lokamyndin verður óskýr, sem gerir skjalupplýsingarnar ólæsilegar og kemur í veg fyrir að hægt sé að skanna gögnin með góðum árangri.",
