...
export default {
  ...
  feedback_messages: {
    ...
    screen_detected: "Premjestite dokument na neutralnu pozadinu",
  ...
  help_modal: {
    ...
    blur: {
      ...
      details_desktop: "Pokušajte za vrijeme skeniranja što mirnije držati uređaj i dokument. Pomicanjem može doći do zamućenja slike zbog čega podaci postaju nečitljivi.",
      title: "Mirno držite dokument",
    },
    camera_lens: {
      details: "Provjerite je li kamera čista. Prljava kamera uzrokuje zamućenje slike pa podaci na dokumentu postaju nečitljivi i nemoguće ih je uspješno skenirati.",
