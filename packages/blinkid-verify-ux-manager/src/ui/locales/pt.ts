...
export default {
  ...
  feedback_messages: {
    ...
    keep_document_still: "Mantenha imóvel",
    ...
    screen_detected: "Mova o documento para um fundo liso",
  ...
  help_modal: {
    ...
    blur: {
      ...
      details_desktop: "Tente manter o dispositivo e o documento imóveis enquanto digitaliza. Mover algum deles poderá desfocar a imagem e tornar os dados do documento ilegíveis.",
      title: "Mantenha-se imóvel enquanto digitaliza",
    },
    camera_lens: {
      details: "Verifique se não há manchas ou poeiras na lente da sua câmara. Uma lente suja torna a imagem final desfocada, deixando os detalhes do documento ilegíveis e impedindo a digitalização correta dos dados.",
