...
export default {
  ...
  feedback_messages: {
    ...
    keep_document_still: "Ne mozogjon",
    ...
    screen_detected: "Helyezze a dokumentumot egyszínű háttér elé",
  ...
  help_modal: {
    ...
    blur: {
      ...
      details_desktop: "A szkennelés során próbálja mozdulatlanul tartani az eszközt és a dokumentumot. Mozgás hatására a kép elmosódhat, a dokumentumon lévő adatok pedig olvashatatlanná válhatnak.",
      title: "Maradjon mozdulatlan a szkennelés során",
    },
    camera_lens: {
      details: "Ellenőrizze, hogy nincs-e folt vagy por a kamera lencséjén. A piszkos lencse elhomályosítja a végső képet, így a dokumentum részletei olvashatatlanná válnak, ami megakadályozza az adatok sikeres beolvasását.",
