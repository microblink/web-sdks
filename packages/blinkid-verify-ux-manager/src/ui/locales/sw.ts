...
export default {
  ...
  feedback_messages: {
    ...
    keep_document_still: "Hakikisha haisongi",
    ...
    screen_detected: "Weka hati kwenye mandharinyuma yasiyo na vitu",
  ...
  help_modal: {
    ...
    blur: {
      ...
      details_desktop: "Jaribu kuhakikisha hati na kifaa havisongi unaposkani. Ukisogeza chochote picha inaweza kukosa kuonekana vizuri na kufanya data kwenye hati isiweze kusomeka.",
      title: "Usisonge unaposkani",
    },
    camera_lens: {
      details: "Angalia lenzi ya kamera yako kama ina uchafu au madoa. Lenzi chafu hufanya picha ya mwisho isionekane vizuri, na kufanya maelezo ya hati yasiweze kusomeka na kuzuia data kuskanikiwa vizuri.",
