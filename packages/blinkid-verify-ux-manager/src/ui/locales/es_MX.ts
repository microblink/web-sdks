...
export default {
  ...
  feedback_messages: {
    ...
    keep_document_still: "Manténgase quieto",
  ...
  help_modal: {
    ...
    blur: {
      ...
      details_desktop: "Intenta mantener el dispositivo y el documento quietos mientras escaneas. Si se mueven, la imagen puede salir borrosa y los datos del documento pueden ser ilegibles.",
      title: "No mover durante el escaneo",
    },
    camera_lens: {
      details: "Revisa si hay manchas o polvo en la lente de la cámara. Si la lente está sucia, la imagen final saldrá borrosa, por lo que los detalles del documento serán ilegibles y no se podrán escanear los datos correctamente.",
