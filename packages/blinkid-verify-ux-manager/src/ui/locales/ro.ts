...
export default {
  ...
  feedback_messages: {
    ...
    keep_document_still: "Nu vă mișcați",
    ...
    screen_detected: "Mutați documentul pe un fundal simplu",
  ...
  help_modal: {
    ...
    blur: {
      ...
      details_desktop: "Încercați să mențineți dispozitivul și documentul nemișcate în timpul scanării. Deplasarea oricăruia poate face imaginea neclară și datele de pe document ilizibile.",
      title: "Nu vă mișcați în timpul scanării",
    },
    camera_lens: {
      details: "Verificați ca lentila camerei să nu prezinte pete sau praf. Folosirea unei lentile murdare duce la o imagine finală neclară, făcând detaliile documentului ilizibile și împiedicând scanarea cu succes a datelor.",
