...
export default {
  ...
  feedback_messages: {
    ...
    keep_document_still: "Pysy liikkumatta",
    ...
    screen_detected: "Siirrä asiakirja yksiväriselle taustalle",
  ...
  help_modal: {
    ...
    blur: {
      ...
      details_desktop: "Yritä pitää laite ja asiakirja paikoillaan skannauksen aikana. Jommankumman liikkuminen voi sumentaa kuvaa ja tehdä asiakirjan tiedoista lukukelvottomia.",
      title: "Pysy paikallasi skannauksen aikana",
    },
    camera_lens: {
      details: "Tarkista kameran linssi tahrojen tai pölyn varalta. Likainen linssi aiheuttaa lopullisen kuvan sumenemista ja tekee asiakirjan tiedoista lukukelvottomia, jolloin tietojen skannaus ei onnistu.",
