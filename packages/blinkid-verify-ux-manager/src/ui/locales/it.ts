...
export default {
  ...
  feedback_messages: {
    ...
    keep_document_still: "Tieni fermo",
    ...
    screen_detected: "Sposta il documento su uno sfondo uniforme",
  ...
  help_modal: {
    ...
    blur: {
      ...
      details_desktop: "Cerca di tenere fermi il dispositivo e il documento durante la scansione. Muoverli può sfocare l'immagine e rendere illeggibili i dati riportati sul documento.",
      title: "Resta immobile durante la scansione",
    },
    camera_lens: {
      details: "Controlla che la lente della fotocamera sia priva di macchie o polvere. Una lente sporca sfoca l'immagine finale, rendendo illeggibili le informazioni riportate sul documento e impedendo la corretta scansione dei dati.",
