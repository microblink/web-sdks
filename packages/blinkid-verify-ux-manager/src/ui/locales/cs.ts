...
export default {
  ...
  feedback_messages: {
    ...
    screen_detected: "Přesuňte dokument na jednobarevné pozadí",
  ...
  help_modal: {
    ...
    blur: {
      ...
      details_desktop: "Při skenování se snažte držet zařízení a dokument v klidu. Pohyb může obraz rozmazat a způsobit, že data na dokumentu nebudou čitelná.",
      title: "Při skenování se nehýbejte",
    },
    camera_lens: {
      details: "Zkontrolujte, zda na objektivu fotoaparátu nejsou šmouhy nebo prach. Špinavý objektiv způsobuje rozmazání výsledného obrazu, což znemožňuje přečtení údajů v dokumentu a úspěšné naskenování dat.",
