...
export default {
  ...
  feedback_messages: {
    ...
    keep_document_still: "Huwag gumalaw",
    ...
    screen_detected: "Ilipat ang dokumento sa harap ng payak na background",
  ...
  help_modal: {
    ...
    blur: {
      ...
      details_desktop: "Panatilihing hindi gumagalaw ang device at dokumento habang nag-i-scan. Puwedeng maging malabo at hindi nababasa ang data sa dokumento kapag gumalaw.",
      title: "Panatilihing hindi gumagalaw habang nag-i-scan",
    },
    camera_lens: {
      details: "Suriin kung may mga mantsa o alikabok ang lens ng camera mo. Nagdudulot ng paglabo ng pinal na larawan ang maruruming lens, na dahilan para hindi mabasa ang mga detalye ng dokumento at hindi pag-scan sa data.",
