...
export default {
  ...
  feedback_messages: {
    ...
    screen_detected: "Alihkan dokumen ke latar belakang yang kosong",
  ...
  help_modal: {
    ...
    blur: {
      ...
      details_desktop: "Cuba kekalkan kedudukan peranti dan dokumen semasa mengimbas. Menggerakkan kedua-duanya boleh mengaburkan imej dan menjadikan data dalam dokumen tidak dapat dibaca.",
      title: "Kekalkan kedudukan semasa mengimbas",
    },
    camera_lens: {
      details: "Periksa lensa kamera anda untuk memastikan tiada kesan kotoran atau habuk. Lensa yang kotor akan menyebabkan imej akhir menjadi kabur, menyebabkan butiran dokumen sukar dibaca dan imbasan data gagal.",
