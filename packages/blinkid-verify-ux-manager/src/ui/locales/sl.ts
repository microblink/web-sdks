...
export default {
  ...
  feedback_messages: {
    ...
    keep_document_still: "Ne premikajte se",
    ...
    screen_detected: "Premaknite dokument na enobarvno ozadje",
  ...
  help_modal: {
    ...
    blur: {
      ...
      details_desktop: "Potrudite se, da bosta med optičnim branjem naprava in dokument pri miru. Če se kateri od njiju premakne, se lahko slika razmaže in bodo podatki na dokumentu neberljivi.",
      title: "Držite pri miru med optičnim branjem",
    },
    camera_lens: {
      details: "Preverite, da ni morda na objektivu kamere kakšna umazanija ali prah. Če je objektiv umazan, dobite zamegljeno končno sliko, zato je potem vsebina dokumenta neberljiva in podatkov ni mogoče uspešno optično prebrati.",
