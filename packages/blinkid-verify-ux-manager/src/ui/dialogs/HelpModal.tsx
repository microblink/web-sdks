...
export const HelpModal: Component<{ isDesktop: boolean }> = (props) => {
      ...
      ? [
          {
            ...
            img: HelpCameraLens,
            description: t.help_modal.camera_lens.details,
          },
        ]
      : []),
    {
      title: t.help_modal.visibility.title,
      img: HelpOcclusion,
      description: t.help_modal.visibility.details,
    },
    {
      title: t.help_modal.lighting.title,
      img: HelpLighting,
      description: t.help_modal.lighting.details,
    },
    {
  ...
  createEffect(
    on(
      ...
      (open) => {
        if (open) {
          void store.blinkIdVerifyUxManager.analytics.logHelpOpenedEvent();
        } else {
          onClose();
        }
      },
...
export const HelpButton: ParentComponent<{ isProcessing: boolean }> = (
  ...
  createEffect(() => {
    if (tooltipOpen()) {
      void store.blinkIdVerifyUxManager.analytics.logHelpTooltipDisplayedEvent();
    }
  });
