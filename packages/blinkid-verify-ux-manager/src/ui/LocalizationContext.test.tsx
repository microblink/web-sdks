...
import { blinkIdVerifyUiStateMap } from "../core/blinkid-verify-ui-state";
import en from "./locales/en";
import { LocalizationProvider, PartialLocalizationStrings } from "./LocalizationContext";
...
const TestFeedbackUi: Component<{
  ...
  <LocalizationProvider userStrings={props.localization}>
    <UiFeedbackOverlay uiState={blinkIdVerifyUiStateMap.INTRO_FRONT_PAGE} isDesktop={false} />
    <UiFeedbackOverlay uiState={blinkIdVerifyUiStateMap.DOCUMENT_FRAMING_CAMERA_TOO_FAR} isDesktop={false} />
...
describe("LocalizationProvider", () => {
  ...
  test("preserves default nested feedback messages when one string is overridden", () => {
    ...
    expect(document.body.textContent).toContain("Custom front side instruction");
    expect(document.body.textContent).toContain(en.feedback_messages.move_closer);
  });
