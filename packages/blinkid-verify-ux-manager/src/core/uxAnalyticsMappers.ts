...
import type { PingUxEventData } from "@microblink/blinkid-verify-core";
import { match } from "ts-pattern";

import type { BlinkIdVerifyUiErrorStateKey } from "./blinkid-verify-ui-state";
 ...
 */
export type PingableErrorUiStateKey = Exclude<BlinkIdVerifyUiErrorStateKey, "UNSUPPORTED_DOCUMENT">;
