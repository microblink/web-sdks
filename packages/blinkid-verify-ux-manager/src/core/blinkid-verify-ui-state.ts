 ...
 */
export const blinkIdVerifyUiIntroStateKeys = [
  "INTRO_FRONT_PAGE",
  "INTRO_BACK_PAGE",
  "INTRO_DATA_PAGE",
  "INTRO_TOP_PAGE",
 ...
 * @see `getChainedUiStateKey` for the automatic state transition logic
 * @see `blinkIdVerifyUiIntroStateKeys` for the intro states that follow transitions
 */
export const blinkIdVerifyPageTransitionKeys = [
  "FLIP_CARD",
  "MOVE_TOP",
  "MOVE_LEFT",
  "MOVE_RIGHT",
...
export type BlinkIdVerifyUiStateKey =
  ...
  | BlinkIdVerifyUiMappableKey;

/**
 * Extended UI state for BlinkID Verify.
 *
 * @template K - The key of the UI state.
 */
export type BlinkIdVerifyUiStateMap = {
  [K in BlinkIdVerifyUiStateKey]: UiState & {
    /** The key of the UI state. */
    key: K;
    /** The type of the reticle. */
    reticleType: BlinkIdVerifyReticleType;
  };
};
  ...
  return (
    match<PartialProcessResult, BlinkIdVerifyUiMappableKey | undefined>(
      ...
      .with(
        {
          resultCompleteness: {
            scanningStatus: "scanning-second",
          },
          inputImageAnalysisResult: {
            extractionInputImageAnalysisResult: {
              processingStatus: "scanning-wrong-side",
              isPassportWithBarcode: true,
            },
          },
        },
        () => "WRONG_LAST_PAGE",
