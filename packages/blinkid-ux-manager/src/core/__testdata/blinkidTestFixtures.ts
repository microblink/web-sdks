...
export const createScanningResult = (overrides: Partial<BlinkIdScanningResult> = {}): BlinkIdScanningResult => {
  return {
    ...overrides,
 ...
 */
export const createProcessResult = (overrides: PartialDeep<ProcessResultWithBuffer> = {}): ProcessResultWithBuffer => {
