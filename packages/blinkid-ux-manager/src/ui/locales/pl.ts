...
export default {
  ...
  help_modal: {
    ...
    barcode_only: {
      blur: {
        details: "Podczas skanowania staraj się trzymać telefon i kod kreskowy nieruchomo. Poruszanie którymkolwiek z nich może rozmyć obraz i utrudnić odczytanie kodu kreskowego.",
        details_desktop: "Staraj się nie ruszać podczas skanowania. Ruch może rozmyć obraz i utrudnić odczytanie kodu kreskowego.",
        title: "Nie ruszaj się podczas skanowania",
        title_desktop: "Nie ruszaj się podczas skanowania",
      },
      camera_lens: {
        details_desktop: "Sprawdź obiektyw aparatu pod kątem smug lub kurzu. Brudny obiektyw powoduje rozmycie końcowego obrazu, przez co kod kreskowy staje się nieczytelny i uniemożliwia pomyślne zeskanowanie danych.",
        title_desktop: "Wyczyść obiektyw aparatu",
      },
      lighting: {
        details: "Unikaj bezpośredniego, ostrego światła, ponieważ może ono powodować odblaski na kodzie kreskowym i utrudniać jego skanowanie. Jeśli kod kreskowy nie jest dla Ciebie wyraźnie widoczny, aparat również może mieć problem z jego odczytaniem.",
        details_desktop: "Unikaj bezpośredniego, ostrego światła, ponieważ może ono powodować odblaski na kodzie kreskowym i utrudniać jego skanowanie. Jeśli kod kreskowy nie jest dla Ciebie wyraźnie widoczny, aparat również może mieć problem z jego odczytaniem.",
        title: "Uważaj na silne światło",
        title_desktop: "Uważaj na silne światło",
      },
      visibility: {
        details: "Upewnij się, że nie zasłaniasz palcem żadnej części kodu kreskowego. Uważaj też na odbicia światła na kodzie kreskowym, które mogą utrudnić jego odczytanie.",
        details_desktop: "Upewnij się, że nie zasłaniasz palcem żadnej części kodu kreskowego. Uważaj też na odbicia światła na kodzie kreskowym, które mogą utrudnić jego odczytanie.",
    ...
    document_with_mrz: {
      ...
      visibility: {
        details: "Upewnij się, że nie zasłaniasz palcem żadnej części strefy MRZ. Uważaj też na odbicia światła na strefie MRZ, które mogą utrudnić jej odczytanie.",
        details_desktop: "Upewnij się, że nie zasłaniasz palcem żadnej części strefy MRZ. Uważaj też na odbicia światła na strefie MRZ, które mogą utrudnić jej odczytanie.",
  ...
  onboarding_modal: {
    ...
    barcode_only: {
      details: "Znajdź kod kreskowy (seria czarnych kresek lub kod kwadratowy). Skieruj na niego aparat i trzymaj nieruchomo — skanowanie nastąpi automatycznie.",
      details_desktop: "Znajdź kod kreskowy (seria czarnych linii lub kod kwadratowy). Upewnij się, że obiektyw aparatu jest czysty, a kod kreskowy dobrze oświetlony.",
      title: "Znajdź i zeskanuj kod kreskowy",
      title_desktop: "Wyczyść obiektyw i znajdź kod kreskowy",
    },
    btn: "Rozpocznij skanowanie",
    document_with_barcode: {
      details: "Różne typy dokumentów mogą mieć odmienne formaty kodów kreskowych oraz ich umiejscowienie. Obejrzyj przód i tył dokumentu, aby znaleźć kod kreskowy.",
      details_desktop: "Sprawdź przód i tył dokumentu, aby znaleźć kod kreskowy. Upewnij się, że obiektyw aparatu jest czysty, a dokument dobrze oświetlony.",
      title: "Zlokalizuj kod kreskowy na dokumencie",
      title_desktop: "Wyczyść obiektyw i znajdź kod kreskowy",
    },
    document_with_mrz: {
      details: "Na dole przedniej lub tylnej strony dokumentu znajdziesz długi ciąg znaków, podzielony na 2 lub 3 wiersze i oddzielony strzałkami (<< lub >>).",
      details_desktop: "Sprawdź przód i tył dokumentu pod kątem strefy MRZ. Poszukaj 2–3 linii znaków i symboli strzałek (<<) na dole dokumentu. Upewnij się, że obiektyw aparatu jest czysty, a dokument dobrze oświetlony.",
  ...
  timeout_modal: {
    ...
    details_desktop: "Upewnij się, że obiektyw aparatu jest czysty, a dokument w pełni widoczny, wyraźny i dobrze oświetlony.",
