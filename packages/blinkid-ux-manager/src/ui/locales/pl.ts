...
export default {
  ...
  document_filtered: "Dokument nie został zaakceptowany",
  document_filtered_details: "Spróbuj zeskanować inny dokument",
  ...
  help_modal_done_btn: "Gotowe",
  help_modal_next_btn: "Dalej",
  help_modal_title_1: "Wszystkie pola powinny być widoczne",
