...
export default {
  ...
  help_modal: {
    ...
    barcode_only: {
      blur: {
        details: "Usahakan ponsel dan kode batang tidak bergerak saat memindai. Jika bergerak, gambar menjadi buram dan kode batang sulit dibaca.",
        details_desktop: "Usahakan tidak bergerak saat memindai. Jika bergerak, gambar menjadi buram dan kode batang sulit dibaca.",
        title: "Pastikan dokumen tidak bergerak saat pemindaian",
        title_desktop: "Pastikan dokumen tidak bergerak saat pemindaian",
      },
      camera_lens: {
        details_desktop: "Pastikan tidak ada noda atau debu pada lensa kamera. Jika lensa kotor, hasil gambar menjadi buram. Akibatnya, kode batang tidak dapat terbaca dan data gagal dipindai.",
        title_desktop: "Bersihkan lensa kamera",
      },
      lighting: {
        details: "Hindari cahaya terang langsung karena dapat menimbulkan efek silau sehingga kode batang sulit dipindai. Jika kode batang tidak terlihat jelas, kamera tidak dapat membacanya.",
        details_desktop: "Hindari cahaya terang langsung karena dapat menimbulkan efek silau sehingga kode batang sulit dipindai. Jika kode batang tidak terlihat jelas, kamera tidak dapat membacanya.",
        title: "Waspadai cahaya tajam",
        title_desktop: "Waspadai cahaya tajam",
      },
      visibility: {
        details: "Pastikan jari Anda tidak menutupi bagian kode batang. Selain itu, hindari pantulan cahaya pada kode batang yang dapat menjadikannya tidak terbaca.",
        details_desktop: "Pastikan jari Anda tidak menutupi bagian kode batang. Selain itu, hindari pantulan cahaya pada kode batang yang dapat menjadikannya tidak terbaca.",
    ...
    document_with_mrz: {
      ...
      visibility: {
        details: "Pastikan jari Anda tidak menutupi bagian MRZ. Selain itu, hindari pantulan cahaya pada MRZ yang dapat menjadikannya tidak terbaca.",
        details_desktop: "Pastikan jari Anda tidak menutupi bagian MRZ. Selain itu, hindari pantulan cahaya pada MRZ yang dapat menjadikannya tidak terbaca.",
  ...
  onboarding_modal: {
    ...
    barcode_only: {
      details: "Cari kode batang (deretan garis hitam atau kode berbentuk kotak). Arahkan kamera ke kode tersebut dan tahan. Pemindaian akan berlangsung secara otomatis.",
      details_desktop: "Cari kode batang (deretan garis hitam atau kode berbentuk kotak). Pastikan lensa kamera bersih dan kode batang cukup terang.",
      title: "Temukan lalu pindai kode batang",
      title_desktop: "Bersihkan lensa kamera dan temukan kode batang",
    },
    btn: "Mulai Pemindaian",
    document_with_barcode: {
      details: "Jenis dokumen berbeda dapat memiliki format dan lokasi kode batang yang berbeda juga. Lihat sisi depan dan belakang dokumen untuk menemukannya.",
      details_desktop: "Periksa sisi depan dan belakang dokumen untuk menemukan kode batang. Pastikan lensa kamera bersih dan dokumen cukup terang.",
      title: "Temukan kode batang pada dokumen",
      title_desktop: "Bersihkan lensa kamera dan temukan kode batang",
    },
    document_with_mrz: {
      details: "Anda akan menemukan deretan karakter panjang di bagian bawah sisi depan atau belakang dokumen, terbagi menjadi 2 atau 3 baris dan dipisahkan oleh tanda panah (<< atau >>).",
      details_desktop: "Periksa sisi depan dan belakang dokumen untuk menemukan MRZ. Cari 2–3 baris karakter dan simbol panah (<<) di bagian bawah dokumen. Pastikan lensa kamera bersih dan dokumen cukup terang.",
  ...
  timeout_modal: {
    ...
    details_desktop: "Pastikan lensa kamera bersih dan dokumen terlihat sepenuhnya, fokus, dan cukup terang.",
