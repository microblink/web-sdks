...
export default {
  ...
  help_modal: {
    ...
    barcode_only: {
      ...
      lighting: {
        details: "Avoid direct harsh light because it can create glare on the barcode and make it difficult to scan. If the barcode isn’t clearly visible to you, the camera may not be able to read it either.",
        details_desktop: "Avoid direct harsh light because it can create glare on the barcode and make it difficult to scan. If the barcode isn’t clearly visible to you, the camera may not be able to read it either.",
        title: "Watch out for harsh light",
        title_desktop: "Watch out for harsh light",
      },
      visibility: {
        details: "Make sure you aren’t covering parts of the barcode with a finger. Also, watch out for reflections that go over the barcode and could make it unreadable.",
        details_desktop: "Make sure you aren’t covering parts of the barcode with a finger. Also, watch out for reflections that go over the barcode and could make it unreadable.",
  ...
  onboarding_modal: {
    ...
    barcode_only: {
      details: "Look for a barcode (a series of black lines or a square code). Point your camera at it and hold still — scanning will happen automatically.",
      details_desktop: "Look for a barcode (a series of black lines or a square code). Make sure you keep your camera lens clean and the barcode well lit.",
  ...
  timeout_modal: {
    ...
    details_desktop: "Make sure your camera lens is clean and the document is fully visible, in focus and well lit.",
