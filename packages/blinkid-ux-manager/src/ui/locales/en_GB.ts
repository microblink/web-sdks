...
export default {
  ...
  error_modal: { cancel_btn: "Cancel", retry_btn: "Retry" },
  feedback_messages: {
  ...
  help_modal: {
    ...
    barcode_only: {
      blur: {
        details:
          "Try to keep the phone and the barcode still while scanning. Moving may either blur the image or make the barcode difficult to read.",
        details_desktop:
          "Try to keep still while scanning. Moving can blur the image and make the barcode difficult to read.",
        title: "Keep still while scanning",
        title_desktop: "Keep still while scanning",
      },
      camera_lens: {
        details_desktop:
          "Check your camera lens for smudges or dust. A dirty lens may cause blurring in the final image, making the barcode unreadable and preventing successful scan of the data.",
        title_desktop: "Clean your camera lens",
      },
      lighting: {
        details:
          "Avoid direct harsh light because it can create glare on the barcode and make it difficult to scan. If the barcode isn’t clearly visible to you, the camera may not be able to read it either.",
        details_desktop:
          "Avoid direct harsh light because it can create glare on the barcode and make it difficult to scan. If the barcode isn’t clearly visible to you, the camera may not be able to read it either.",
      ...
      visibility: {
        details:
          "Make sure you aren’t covering parts of the barcode with a finger. Also, watch out for reflections that go over the barcode and could make it unreadable.",
        details_desktop:
          "Make sure you aren’t covering parts of the barcode with a finger. Also, watch out for reflections that go over the barcode and could make it unreadable.",
        title: "Keep the barcode visible",
    ...
    document_with_barcode: {
      blur: {
        ...
        details_desktop:
          "Try to keep still while scanning. Moving may blur the image and make data on the document unreadable.",
        title: "Keep still while scanning",
        title_desktop: "Keep still while scanning",
      },
      camera_lens: {
    ...
    document_with_mrz: {
      ...
      visibility: {
        details:
          "Make sure you are not covering any part of the MRZ with a finger. Also, watch out for glare across the MRZ, as it may make it unreadable.",
        details_desktop:
          "Make sure you are not covering any part of the MRZ with a finger. Also, watch out for glare across the MRZ, as it may make it unreadable.",
  ...
  onboarding_modal: {
    ...
    barcode_only: {
      details:
        "Look for a barcode (a series of black lines or a square code). Point your camera at it and hold still — scanning will happen automatically.",
      details_desktop:
        "Look for a barcode (a series of black lines or a square code). Make sure you keep your camera lens clean and the barcode well lit.",
    ...
    document_with_barcode: {
      details:
        "Different types of document may have different barcode formats and locations. Check both the front and back of the document for a barcode.",
      details_desktop:
        "Check the front and back of the document for a barcode. Make sure your camera lens is clean and the document is well lit.",
      title: "Locate the barcode on the document",
      title_desktop: "Clean your lens and locate barcode",
    },
    document_with_mrz: {
      details:
        "You'll find a long string of characters at the bottom of the front or back of the document, arranged in 2 or 3 lines and separated by chevrons (<< or >>).",
      details_desktop:
        "Check the front and back of the document for an MRZ. Look for 2 or 3 lines of characters and chevrons (<<) at the bottom of the document. Make sure your camera lens is clean and the document is well lit.",
  ...
  timeout_modal: {
    details:
      "Make sure the document is well lit, fully visible and free from glare.",
    details_desktop:
