...
export default {
  ...
  document_filtered: "دستاویز قبول نہیں کی گئی",
  document_filtered_details: "کسی اور دستاویز کو اسکین کرنے کی کوشش کریں۔",
  ...
  help_modal_done_btn: "ہو گیا",
  help_modal_next_btn: "اگلا",
  help_modal_title_1: "تمام خانے نمایاں رکھیں",
