...
export default {
  ...
  feedback_messages: {
    ...
    glare_detected: "Nagnite ili premjestite dokument kako biste uklonili refleksiju",
  ...
  help_modal: {
    ...
    barcode_only: {
      blur: {
        details: "Pokušajte za vrijeme skeniranja što mirnije držati telefon i barkod. Pomicanjem može doći do zamućenja slike zbog čega barkod postaje nečitljiv.",
        details_desktop: "Pokušajte za vrijeme skeniranja biti što mirniji. Pomicanjem može doći do zamućenja slike zbog čega barkod postaje nečitljiv.",
        title: "Mirno držite dokument",
        title_desktop: "Mirno držite dokument",
      },
      camera_lens: {
        details_desktop: "Provjerite je li kamera čista. Prljava kamera uzrokuje zamućenje slike pa barkod postaje nečitljiv i nemoguće ga je uspješno skenirati.",
        title_desktop: "Očistite kameru",
      },
      lighting: {
        details: "Izbjegavajte izravnu jaku svjetlost jer može uzrokovati odsjaj na barkodu i otežati skeniranje. Ako vi ne vidite jasno barkod, ni kamera ga neće moći očitati.",
        details_desktop: "Izbjegavajte izravnu jaku svjetlost jer može uzrokovati odsjaj na barkodu i otežati skeniranje. Ako vi ne vidite jasno barkod, ni kamera ga neće moći očitati.",
        title: "Pazite na direktno osvjetljenje",
        title_desktop: "Pazite na direktno osvjetljenje",
      },
      visibility: {
        details: "Pripazite da ne prekrivate dijelove barkoda prstom. Također, pazite na refleksije koje mogu prelaziti preko barkoda i učiniti ga nečitljivim.",
        details_desktop: "Pripazite da ne prekrivate dijelove barkoda prstom. Također, pazite na refleksije koje mogu prelaziti preko barkoda i učiniti ga nečitljivim.",
    ...
    document_with_mrz: {
      ...
      visibility: {
        details: "Pripazite da ne prekrivate dijelove MRZ-a prstom. Također, pazite na refleksije koje mogu prelaziti preko MRZ-a i učiniti ga nečitljivim.",
        details_desktop: "Pripazite da ne prekrivate dijelove MRZ-a prstom. Također, pazite na refleksije koje mogu prelaziti preko MRZ-a i učiniti ga nečitljivim.",
  ...
  onboarding_modal: {
    ...
    barcode_only: {
      details: "Potražite barkod (niz crnih linija ili kvadratni kod). Usmjerite kameru prema njemu i držite ga mirno — skeniranje će se pokrenuti automatski.",
      details_desktop: "Potražite barkod (niz crnih linija ili kvadratni kod). Pazite da je kamera čista i barkod dobro osvijetljen.",
      title: "Locirajte i skenirajte barkod",
      title_desktop: "Očistite kameru i locirajte barkod",
    },
    btn: "Započnite skeniranje",
    document_with_barcode: {
      details: "Različite vrste dokumenata mogu imati različite formate i položaje barkoda. Provjerite prednju i stražnju stranu dokumenta kako biste pronašli barkod.",
      details_desktop: "Provjerite prednju i stražnju stranu dokumenta kako biste pronašli barkod. Pazite da je kamera čista i dokument dobro osvijetljen.",
      title: "Locirajte barkod na dokumentu",
      title_desktop: "Očistite kameru i locirajte barkod",
    },
    document_with_mrz: {
      details: "Na dnu prednje ili stražnje strane dokumenta pronaći ćete dugačak niz znakova, raspoređen u 2 ili 3 retka i odvojen strelicama (<< ili >>).",
      details_desktop: "Provjerite prednju i stražnju stranu dokumenta kako biste pronašli MRZ. Potražite 2–3 retka znakova i simbola strelica (<<) pri dnu dokumenta. Pazite da je kamera čista i dokument dobro osvijetljen.",
      title: "Locirajte MRZ na dokumentu",
      title_desktop: "Očistite kameru i locirajte MRZ",
    },
    full_document: {
      details: "Pripazite da dokument bude dovoljno osvijetljen. Svi podaci s dokumenta trebaju biti vidljivi na ekranu vašeg uređaja.",
  ...
  timeout_modal: {
    details: "Pripazite da je dokument dobro osvijetljen, u potpunosti vidljiv i bez odsjaja.",
    details_desktop: "Pobrinite se da je kamera čista te da je dokument u potpunosti vidljiv, izoštren i dobro osvijetljen.",
