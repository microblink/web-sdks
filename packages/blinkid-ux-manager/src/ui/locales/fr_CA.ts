...
export default {
  ...
  document_filtered: "Document non accepté",
  document_filtered_details: "Veuillez essayer de numériser un autre document.",
  ...
  front_side_scanned: "Succès ! Face avant numérisée",
  glare_detected:
  ...
  help_modal_title_1: "Veillez à ce que tous les champs soient visibles.",
