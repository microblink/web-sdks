...
export default {
  ...
  feedback_messages: {
    ...
    glare_detected: "Inclinez ou déplacez le document pour éliminer les reflets",
    ...
    scan_the_barcode_side: "Numérisez la face du document sur laquelle se trouve le code-barres",
    scan_the_front_side: "Numérisez le recto du document",
    scan_the_mrz_side: "Numérisez la face du document sur laquelle se trouve la ZLA",
  ...
  help_modal: {
    ...
    barcode_only: {
      blur: {
        details: "Essayez de maintenir le téléphone et le code-barres immobiles pendant la numérisation. Tout mouvement peut rendre l'image floue et le code-barres difficile à lire.",
        details_desktop: "Essayez de rester immobile pendant la numérisation. Tout mouvement peut rendre l'image floue et le code-barres difficile à lire.",
        title: "Restez immobile pendant le scan.",
        title_desktop: "Restez immobile pendant le scan.",
      },
      camera_lens: {
        details_desktop: "Vérifiez que l'objectif de votre appareil photo ne présente pas de trace ou de poussière. Un objectif sale rend le code-barres illisible et empêche la bonne numérisation des données.",
        title_desktop: "Nettoyez l'objectif de votre appareil photo",
      },
      lighting: {
        details: "Évitez la lumière directe et intense, car elle peut créer des reflets sur le code-barres et le rendre difficile à numériser. Si le code-barres n'est pas clairement visible pour vous, il se peut que l'appareil photo ne parvienne pas non plus à le lire.",
        details_desktop: "Évitez la lumière directe et intense, car elle peut créer des reflets sur le code-barres et le rendre difficile à numériser. Si le code-barres n'est pas clairement visible pour vous, il se peut que l'appareil photo ne parvienne pas non plus à le lire.",
        title: "Faites attention à la lumière vive",
        title_desktop: "Faites attention à la lumière vive",
      },
      visibility: {
        details: "Assurez-vous de ne pas couvrir certaines parties du code-barres avec un doigt. Faites également attention aux reflets qui pourraient se refléter sur le code-barres et le rendre illisible.",
        details_desktop: "Assurez-vous de ne pas couvrir certaines parties du code-barres avec un doigt. Faites également attention aux reflets qui pourraient se refléter sur le code-barres et le rendre illisible.",
    ...
    document_with_mrz: {
      ...
      visibility: {
        details: "Assurez-vous de ne pas couvrir certaines parties de la ZLA avec un doigt. Faites également attention aux reflets qui pourraient apparaître sur le code-barres et le rendre illisible.",
        details_desktop: "Assurez-vous de ne pas couvrir certaines parties de la ZLA avec un doigt. Faites également attention aux reflets qui pourraient apparaître sur le code-barres et le rendre illisible.",
  ...
  onboarding_modal: {
    ...
    barcode_only: {
      details: "Recherchez un code-barres (une série de lignes noires ou un code carré). Dirigez votre appareil photo vers celui-ci et restez parfaitement immobile : la numérisation se fera automatiquement.",
      details_desktop: "Recherchez un code-barres (une série de lignes noires ou un code carré). Assurez-vous que l'objectif de votre appareil photo est propre et le code-barres bien éclairé.",
    ...
    document_with_barcode: {
      details: "Les différents types de document peuvent posséder des formats et des emplacements de code-barres distincts. Vérifiez la présence d'un code-barres au recto et au verso du document.",
      details_desktop: "Assurez-vous que recto ou le verso du document comporte un code-barres. Vérifiez que l'objectif de votre appareil photo est propre et le document bien éclairé.",
      title: "Localisez le code-barres sur le document",
      title_desktop: "Nettoyez votre objectif et localisez le code-barres",
    },
    document_with_mrz: {
      details: "Vous trouverez une longue suite de caractères au bas de la première ou de la dernière page du document, répartie sur deux ou trois lignes et séparée par des flèches (<< ou >>).",
      details_desktop: "Vérifiez la présence d'une ZLA au recto et au verso du document. Recherchez 2 à 3 lignes de caractères et des flèches (<<) au bas du document. Veillez à ce que l'objectif de votre appareil photo soit propre et que le document soit bien éclairé.",
      title: "Localisez la ZLA sur le document",
      title_desktop: "Nettoyez votre objectif et localisez la ZLA",
    },
    full_document: {
      details: "Assurez-vous que le document est bien éclairé. Tous les champs du document doivent être visibles sur l'écran de l'appareil photo.",
  ...
  timeout_modal: {
    details: "Vérifiez que le document est bien éclairé, entièrement visible et exempt de reflets.",
    details_desktop: "Assurez-vous que l'objectif de votre appareil photo est propre et que le document est entièrement visible, net et bien éclairé.",
