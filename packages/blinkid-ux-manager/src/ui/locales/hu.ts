...
export default {
  ...
  onboarding_modal: {
    ...
    document_with_barcode: {
      details:
        "A különböző típusú dokumentumok eltérő vonalkód-formátummal és helyekkel rendelkezhetnek. Nézze meg az azonosító elejét és hátulját, hogy megtalálja a vonalkódot.",
      details_desktop:
        "Ellenőrizze az igazolvány elejét és hátulját vonalkódot keresve. Ügyeljen rá, hogy a kamera lencséje tiszta legyen, és a dokumentum jól meg legyen világítva.",
      title: "Keresse meg a vonalkódot az azonosítón",
      title_desktop: "Tisztítsa meg a lencsét, és keresse meg a vonalkódot",
    },
    full_document: {
      details:
