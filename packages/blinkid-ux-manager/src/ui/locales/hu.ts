...
export default {
  ...
  feedback_messages: {
    blur_detected: "Tartsa mozdulatlanul a dokumentumot és a telefont",
    ...
    face_photo_not_fully_visible: "Ügyeljen arra, hogy az arckép teljes egészében látható legyen",
    ...
    glare_detected: "Döntse meg vagy mozdítsa el a dokumentumot a tükröződés megszüntetéséhez",
    keep_document_parallel: "Tartsa a dokumentumot a képernyővel párhuzamosan",
    ...
    scan_the_front_side: "Szkennelje be a dokumentum elülső oldalát",
  ...
  help_modal: {
    ...
    barcode_only: {
      blur: {
        details: "Próbálja mozdulatlanul tartani a telefont és a vonalkódot a beolvasás alatt. Ha valamelyik mozog, elmosódhat a kép, és a vonalkód nehezen olvashatóvá válhat.",
        details_desktop: "Próbáljon mozdulatlan maradni a beolvasáskor.Ha mozog, a kép elmosódott lehet, és így nehéz lehet a vonalkód beolvasása.",
        title: "Maradjon mozdulatlan a szkennelés során",
        title_desktop: "Maradjon mozdulatlan a szkennelés során",
      },
      camera_lens: {
        details_desktop: "Ellenőrizze, hogy nincs-e maszat vagy por a lencsén. Ha a lencse koszos, a végső kép elmosódhat, így a vonalkód olvashatatlanná válhat, és nem lehetséges az adatokat beolvasni.",
        title_desktop: "Tisztítsa meg a kameralencsét",
      },
      lighting: {
        details: "Kerülje a közvetlen, erős fényt, mert tükröződést okozhat a vonalkódon, és megnehezítheti a beolvasást. Ha a vonalkód az Ön számára sem látható tisztán, valószínűleg a kamera sem tudja beolvasni.",
        details_desktop: "Kerülje a közvetlen, erős fényt, mert tükröződést okozhat a vonalkódon, és megnehezítheti a beolvasást. Ha a vonalkód az Ön számára sem látható tisztán, valószínűleg a kamera sem tudja beolvasni.",
        title: "Ügyeljen az erős fényre",
        title_desktop: "Ügyeljen az erős fényre",
      },
      visibility: {
        details: "Ügyeljen arra, hogy a vonalkód egyes részeit ne takarja el az ujjával. Ezenkívül ügyeljen a tükröződésekre, amelyek a vonalkódon áthaladnak, és olvashatatlanná tehetik azt.",
        details_desktop: "Ügyeljen arra, hogy a vonalkód egyes részeit ne takarja el az ujjával. Ezenkívül ügyeljen a tükröződésekre, amelyek a vonalkódon áthaladnak, és olvashatatlanná tehetik azt.",
    ...
    document_with_mrz: {
      ...
      visibility: {
        details: "Ügyeljen arra, hogy az MRZ egyes részeit ne takarja el az ujjával. Ezenkívül ügyeljen az MRZ kódot átfedő tükröződésekre is, amelyek olvashatatlanná tehetik.",
        details_desktop: "Ügyeljen arra, hogy az MRZ egyes részeit ne takarja el az ujjával. Ezenkívül ügyeljen az MRZ kódot átfedő tükröződésekre is, amelyek olvashatatlanná tehetik.",
  ...
  onboarding_modal: {
    ...
    barcode_only: {
      details: "Keressen vonalkódot (egymás melletti fekete vonalak vagy  négyzet alakú kód). Irányítsa rá a kamerát, és tartsa mozdulatlanul – a beolvasás automatikusan megtörténik.",
      details_desktop: "Keressen vonalkódot (több egymás melletti vékony vonal vagy négyzet alakú kód). Ügyeljen rá, hogy a kamera lencséja tiszta és a vonalkód jól megvilágított legyen.",
    ...
    document_with_barcode: {
      details: "A különböző típusú okmányok eltérő vonalkód-formátummal és -helyekkel rendelkezhetnek. Nézze meg az okmány elejét és hátulját, hogy megtalálja a vonalkódot.",
      details_desktop: "Ellenőrizze az okmány elejét és hátulját vonalkódot keresve. Ügyeljen rá, hogy a kamera lencséje tiszta legyen, és az okmány jól meg legyen világítva.",
      title: "Keresse meg a vonalkódot az okmányon",
      title_desktop: "Tisztítsa meg a lencsét, és keresse meg a vonalkódot",
    },
    document_with_mrz: {
      details: "Az okmény elején vagy hátoldalán egy hosszú karaktersort talál, amely 2 vagy 3 sorra van osztva, valamint (<< vagy >>) nyilak választják el.",
      details_desktop: "Ellenőrizze az okmány elejét és hátoldalát, és keresse meg az MRZ kódot. Ez 2–3 karaktersorból és nyíl szimbólumokból (<<) áll, és az okmány alján helyezkedik el. Ügyeljen arra, hogy a kamera lencséje tiszta legyen, és a dokumentum jól meg legyen világítva.",
      title: "Keresse meg az MRZ kódot az okmányon",
      title_desktop: "Tisztítsa meg a lencsét, és keresse meg az MRZ kódot",
    },
    full_document: {
      details: "Ügyeljen a dokumentum megfelelő megvilágítására. Minden dokumentummezőnek láthatónak kell lennie a kameraképernyőn.",
  ...
  timeout_modal: {
    details: "Ügyeljen rá, hogy az okmány jól meg legyen világítva, teljesen látható legyen és ne legyen rajta becsillanás.",
    details_desktop: "Ügyeljen rá, hogy a kamera lencséje tiszta legyen, az okmány pedig teljesen látható és éles legyen, valamint jól meg legyen világítva.",
