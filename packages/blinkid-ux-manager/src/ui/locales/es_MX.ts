...
export default {
  ...
  feedback_messages: {
    ...
    scan_the_barcode_side: "Escanea el código de carras a un lado del documento",
  ...
  help_modal: {
    ...
    barcode_only: {
      blur: {
        details: "Trate de mantener el teléfono y el código de barras quietos mientras escanea. Mover cualquiera de los dos puede hacer que la imagen se vea borrosa y esto dificultara la lectura del código de barras.",
        details_desktop: "Intente mantenerse quieto mientras escanea. Al moverse puede hacer que la imagen se vea borrosa y esto dificultará la lectura del código de barras.",
        title: "No mover durante el escaneo",
        title_desktop: "No mover durante el escaneo",
      },
      camera_lens: {
        details_desktop: "Revise el lente de su cámara por manchones o polvo. Los lentes sucios provocan que la imagen final esté borrosa.",
        title_desktop: "Limpie la lente de la cámara",
      },
      lighting: {
        details: "Evite luz intensa de manera directa, ya que esto puede provocar reflejos en el código de barras y esto dificultara su lectura. Si el código de barras no es visible para usted, la cámara tampoco será capaz de leerlo.",
        details_desktop: "Evite luz intensa de manera directa, ya que esto puede provocar reflejos en el código de barras y esto dificultara su lectura. Si el código de barras no es visible para usted, la cámara tampoco será capaz de leerlo.",
        title: "Atención al exceso de luz",
        title_desktop: "Atención al exceso de luz",
      },
      visibility: {
        details: "Asegúrese de que no esté cubriendo partes del código de barras con un dedo. También, asegúrese que ningún reflejo se proyecte sobre el código de barras que pueda hacerlo ilegible.",
        details_desktop: "Asegúrese de que no esté cubriendo partes del código de barras con un dedo. También, asegúrese que ningún reflejo se proyecte sobre el código de barras que pueda hacerlo ilegible.",
    ...
    document_with_mrz: {
      ...
      visibility: {
        details: "Asegúrate de no cubrir partes de la MRZ con un dedo. También, tenga cuidado con los reflejos que puedan pasar sobre la MRZ, ya que podrían hacerla ilegible.",
        details_desktop: "Asegúrate de no cubrir partes de la MRZ con un dedo. También, tenga cuidado con los reflejos que puedan pasar sobre la MRZ, ya que podrían hacerla ilegible.",
  ...
  onboarding_modal: {
    ...
    barcode_only: {
      details: "Busque por un código de barras (una serie de líneas negras o un código cuadrado). Apunte su cámara a él y manténgase quieto — el escaneo ocurrirá automáticamente.",
      details_desktop: "Busque un código de barras (una serie de líneas negras o un código cuadrado), Asegúrese de mantener el lente de su cámara limpio y el código de barras bien iluminado.",
    ...
    document_with_barcode: {
      details: "Diferentes tipos de documentos pueden tener diferentes formatos de códigos de barras y ubicaciones. Revise el frente y reverso del documento para verificar si tiene un código de barras.",
      details_desktop: "Revise el frente y el reverso del documento para verificar si tiene un código de barras. Asegúrese de mantener el lente de su cámara limpio y el documento bien iluminado.",
      title: "Localice el código de barras en el documento",
      title_desktop: "Limpie su lente y ubique el código de barras.",
    },
    document_with_mrz: {
      details: "Encontrará una larga cadena de caracteres en la parte inferior del frente o el reverso del documento, dividida en 2 o 3 líneas y separada por flechas (<< o >>).",
      details_desktop: "Revisa el frente y el reverso del documento para verificar si tiene una MRZ. Busca 2 o 3 líneas de caracteres con símbolos de flecha (<<) en la parte inferior del documento. Asegúrese de mantener el lente de la cámara limpio y el documento bien iluminado.",
      title: "Localice la MRZ en el documento",
      title_desktop: "Limpie su lente y localice la MRZ",
    },
    full_document: {
      details: "Asegúrate de que el documento esté bien iluminado. Deberán verse todos los campos del documento en la pantalla de la cámara.",
  ...
  timeout_modal: {
    details: "Asegúrese de que el documento esté bien iluminado, completamente visible y libre de reflejos.",
    details_desktop: "Asegúrese de que el lente de su cámara esté limpio y que el documento sea completamente visible, enfocado y bien iluminado.",
