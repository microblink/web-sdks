...
export default {
  ...
  feedback_messages: {
    blur_detected: "Giữ yên tài liệu và điện thoại",
    camera_angle_too_steep: "Giữ tài liệu song song với điện thoại",
    document_scanned_aria: "Thành công! Đã quét tài liệu",
    document_too_close_to_edge: "Di chuyển xa hơn",
    face_photo_not_fully_visible: "Đảm bảo ảnh khuôn mặt hiển thị đầy đủ",
    flip_document: "Lật tài liệu",
    flip_to_back_side: "Lật tài liệu",
    front_side_scanned_aria: "Thành công! Đã quét mặt trước",
    glare_detected: "Nghiêng hoặc di chuyển tài liệu để loại bỏ ánh phản chiếu",
    keep_document_parallel: "Giữ tài liệu song song với màn hình",
    keep_still: "Giữ yên",
  ...
  help_modal: {
    ...
    barcode_only: {
      blur: {
        details: "Cố gắng giữ yên điện thoại và mã vạch trong khi quét. Di chuyển có thể làm mờ hình ảnh hoặc khiến mã vạch khó đọc.",
        details_desktop: "Cố gắng giữ yên khi quét. Di chuyển có thể làm mờ hình ảnh hoặc khiến mã vạch khó đọc.",
        title: "Giữ cố định trong khi quét",
        title_desktop: "Giữ cố định trong khi quét",
      },
      camera_lens: {
        details_desktop: "Kiểm tra ống kính camera xem có vết bẩn hoặc bụi không. Ống kính bẩn sẽ khiến hình ảnh cuối bị mờ, làm cho mã vạch không thể đọc được và ngăn cản việc quét dữ liệu thành công.",
        title_desktop: "Làm sạch ống kính camera",
      },
      lighting: {
        details: "Tránh ánh sáng gay gắt trực tiếp vì nó có thể tạo ra lóa sáng trên mã vạch và khiến việc quét trở nên khó khăn. Nếu mã vạch không rõ ràng với bạn, camera cũng có thể không đọc được.",
        details_desktop: "Tránh ánh sáng gay gắt trực tiếp vì nó có thể tạo ra lóa sáng trên mã vạch và khiến việc quét trở nên khó khăn. Nếu mã vạch không rõ ràng với bạn, camera cũng có thể không đọc được.",
        title: "Đề phòng ánh sáng gay gắt",
        title_desktop: "Đề phòng ánh sáng gay gắt",
      },
      visibility: {
        details: "Đảm bảo bạn không dùng ngón tay che các phần của mã vạch. Ngoài ra, hãy coi chừng ánh sáng phản chiếu trên mã vạch có thể khiến mã vạch không thể đọc được.",
        details_desktop: "Đảm bảo bạn không dùng ngón tay che các phần của mã vạch. Ngoài ra, hãy coi chừng ánh sáng phản chiếu trên mã vạch có thể khiến mã vạch không thể đọc được.",
    ...
    document_with_mrz: {
      ...
      visibility: {
        details: "Đảm bảo bạn không dùng ngón tay che các phần của MRZ. Ngoài ra, hãy chú ý tránh để các vệt phản chiếu ánh sáng đè lên MRZ có thể khiến MRZ không đọc được.",
        details_desktop: "Đảm bảo bạn không dùng ngón tay che các phần của MRZ. Ngoài ra, hãy chú ý tránh để các vệt phản chiếu ánh sáng đè lên MRZ có thể khiến MRZ không đọc được.",
  ...
  onboarding_modal: {
    aria: "Hướng dẫn quét",
    barcode_only: {
      details: "Tìm mã vạch (một dãy các đường kẻ đen hoặc mã vuông). Hướng camera của bạn về phía nó và giữ yên — quá trình quét sẽ tự động diễn ra.",
      details_desktop: "Tìm mã vạch (một dãy các đường kẻ đen hoặc mã vuông). Đảm bảo rằng ống kính camera của bạn sạch và mã vạch được chiếu sáng tốt.",
      title: "Tìm và quét mã vạch",
      title_desktop: "Làm sạch ống kính và tìm mã vạch",
    },
    btn: "Bắt đầu quét",
    document_with_barcode: {
      details: "Các loại giấy tờ khác nhau có thể có định dạng và vị trí mã vạch khác nhau. Hãy xem mặt trước và mặt sau của giấy tờ để tìm mã vạch.",
      details_desktop: "Kiểm tra mặt trước và mặt sau của giấy tờ để tìm mã vạch. Đảm bảo rằng bạn giữ ống kính camera sạch sẽ và giấy tờ được chiếu sáng tốt.",
      title: "Xác định vị trí mã vạch trên giấy tờ",
      title_desktop: "Làm sạch ống kính và tìm mã vạch",
    },
    document_with_mrz: {
      details: "Bạn sẽ tìm thấy một chuỗi ký tự dài ở phía dưới mặt trước hoặc mặt sau của giấy tờ, chia thành 2 hoặc 3 dòng và được phân tách bằng mũi tên (<< hoặc >>).",
      details_desktop: "Kiểm tra mặt trước và mặt sau của giấy tờ để tìm MRZ. Hãy tìm 2–3 dòng ký tự và các ký hiệu mũi tên (<<) ở phần dưới cùng của giấy tờ. Đảm bảo ống kính camera của bạn sạch sẽ và giấy tờ được chiếu sáng đầy đủ.",
      title: "Xác định vị trí MRZ trên giấy tờ",
      title_desktop: "Lau sạch ống kính và xác định vị trí MRZ",
    },
    full_document: {
      details: "Đảm bảo rằng bạn giữ cho tài liệu được chiếu sáng tốt. Tất cả các trường tài liệu sẽ hiển thị trên màn hình camera.",
  ...
  timeout_modal: {
    details: "Đảm bảo giấy tờ được chiếu sáng tốt, có thể nhìn rõ toàn bộ và không bị lóa.",
    details_desktop: "Đảm bảo ống kính camera của bạn sạch sẽ và giấy tờ có thể nhìn rõ toàn bộ, rõ nét cũng như được chiếu sáng tốt.",
