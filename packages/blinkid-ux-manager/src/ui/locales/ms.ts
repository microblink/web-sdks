...
export default {
  ...
  feedback_messages: {
    blur_detected: "Pastikan dokumen dan telefon tidak bergerak",
    camera_angle_too_steep: "Pastikan dokumen selari dengan telefon",
    document_scanned_aria: "Berjaya! Dokumen telah diimbas",
    document_too_close_to_edge: "Jauhkan lagi",
    face_photo_not_fully_visible: "Pastikan foto wajah kelihatan sepenuhnya",
    ...
    glare_detected: "Condongkan atau alihkan dokumen untuk menghilangkan pantulan",
    keep_document_parallel: "Pastikan dokumen selari dengan skrin",
  ...
  help_modal: {
    ...
    barcode_only: {
      blur: {
        details: "Cuba kekalkan kedudukan telefon dan kod bar semasa mengimbas. Jika salah satu bergerak, imej boleh menjadi kabur dan menyebabkan kod bar sukar dibaca.",
        details_desktop: "Cuba kekalkan kedudukan semasa mengimbas. Pergerakan boleh mengaburkan imej dan menyebabkan kod bar sukar dibaca.",
        title: "Kekalkan kedudukan semasa mengimbas",
        title_desktop: "Kekalkan kedudukan semasa mengimbas",
      },
      camera_lens: {
        details_desktop: "Periksa lensa kamera anda untuk memastikan tiada kesan kotoran atau habuk. Lensa yang kotor menyebabkan imej akhir menjadi kabur, membuatkan kod bar tidak dapat dibaca dan imbasan data gagal.",
        title_desktop: "Bersihkan lensa kamera anda",
      },
      lighting: {
        details: "Jauhi cahaya yang boleh menyilaukan mata kerana cahaya tersebut boleh menyebabkan silau pada kod bar dan menyukarkan imbasan. Jika kod bar tidak jelas kelihatan kepada anda, kamera juga mungkin tidak dapat membacanya.",
        details_desktop: "Jauhi cahaya yang boleh menyilaukan mata kerana cahaya tersebut boleh menyebabkan silau pada kod bar dan menyukarkan imbasan. Jika kod bar tidak jelas kelihatan kepada anda, kamera juga mungkin tidak dapat membacanya.",
        title: "Jaga-jaga dengan cahaya yang menyilaukan mata",
        title_desktop: "Jaga-jaga dengan cahaya yang menyilaukan mata",
      },
      visibility: {
        details: "Pastikan anda tidak menutup mana-mana bahagian kod bar dengan jari. Selain itu, berhati-hati dengan pantulan cahaya yang merentasi kod bar dan boleh menjadikannya tidak boleh dibaca.",
        details_desktop: "Pastikan anda tidak menutup mana-mana bahagian kod bar dengan jari. Selain itu, berhati-hati dengan pantulan cahaya yang merentasi kod bar dan boleh menjadikannya tidak boleh dibaca.",
    ...
    document_with_mrz: {
      ...
      visibility: {
        details: "Pastikan tiada bahagian MRZ yang terlindung oleh jari anda. Selain itu, pastikan tiada pantulan cahaya pada MRZ yang boleh menyebabkannya sukar atau gagal dibaca.",
        details_desktop: "Pastikan tiada bahagian MRZ yang terlindung oleh jari anda. Selain itu, pastikan tiada pantulan cahaya pada MRZ yang boleh menyebabkannya sukar atau gagal dibaca.",
  ...
  onboarding_modal: {
    ...
    barcode_only: {
      details: "Cari kod bar (satu siri garisan hitam atau kod berbentuk segi empat). Halakan kamera anda ke arahnya dan jangan bergerak — imbasan akan berlaku secara automatik.",
      details_desktop: "Cari kod bar (satu siri garisan hitam atau kod berbentuk segi empat). Pastikan lensa kamera anda bersih dan kod bar mendapat pencahayaan yang baik.",
      title: "Cari dan imbas kod bar",
      title_desktop: "Bersihkan lensa kamera anda dan cari kod bar.",
    },
    btn: "Mula Mengimbas",
    document_with_barcode: {
      details: "Jenis dokumen yang berbeza mungkin mempunyai format dan lokasi kod bar yang berbeza. Lihat bahagian depan dan belakang dokumen untuk kod bar.",
      details_desktop: "Periksa bahagian hadapan dan belakang dokumen untuk mencari kod bar. Pastikan lensa kamera anda bersih dan dokumen mempunyai pencahayaan yang mencukupi.",
      title: "Cari kod bar pada dokumen",
      title_desktop: "Bersihkan lensa kamera anda dan cari kod bar.",
    },
    document_with_mrz: {
      details: "Anda akan menemukan rentetan aksara yang panjang di bahagian bawah muka hadapan atau belakang dokumen, terdiri daripada 2 atau 3 baris dan dipisahkan oleh simbol anak panah (<< atau >>).",
      details_desktop: "Periksa bahagian hadapan dan belakang dokumen untuk mencari MRZ. Cari 2 hingga 3 baris aksara bersama simbol (<<) di bahagian bawah dokumen. Pastikan lensa kamera bersih dan dokumen diterangi dengan baik.",
      title: "Kenal pasti MRZ pada dokumen.",
      title_desktop: "Bersihkan lensa dan cari MRZ.",
    },
    full_document: {
      details: "Pastikan dokumen anda menerima pencahayaan yang cukup. Semua medan dokumen hendaklah kelihatan pada skrin kamera.",
  ...
  timeout_modal: {
    details: "Pastikan dokumen mempunyai pencahayaan yang mencukupi, kelihatan sepenuhnya dan bebas daripada silau.",
    details_desktop: "Pastikan lensa kamera bersih dan keseluruhan dokumen dapat dilihat dengan jelas, berada dalam fokus serta diterangi dengan baik.",
