...
export default {
  ...
  feedback_messages: {
    blur_detected: "Țineți documentul și telefonul nemișcate",
    camera_angle_too_steep: "Țineți documentul paralel cu telefonul",
    ...
    glare_detected: "Înclinați sau mișcați documentul pentru a elimina reflexia",
    ...
    scan_the_front_side: "Scanați partea din față a documentului",
  ...
  help_modal: {
    ...
    barcode_only: {
      blur: {
        details: "Încercați să mențineți telefonul și codul de bare nemișcate în timpul scanării. Mișcarea oricăruia dintre ele poate face ca imaginea să fie neclară și poate îngreuna citirea codului de bare.",
        details_desktop: "Încercați să nu vă mișcați în timpul scanării. Mișcarea poate face ca imaginea să fie neclară și poate îngreuna citirea codului de bare.",
        title: "Nu vă mișcați în timpul scanării",
        title_desktop: "Nu vă mișcați în timpul scanării",
      },
      camera_lens: {
        details_desktop: "Verificați dacă obiectivul camerei nu are pete sau praf. Un obiectiv murdar face ca imaginea finală să fie neclară, făcând codul de bare ilizibil și împiedicând scanarea cu succes a datelor.",
        title_desktop: "Curățați lentila camerei",
      },
      lighting: {
        details: "Evitați lumina puternică directă, deoarece aceasta poate crea reflexii pe codul de bare și poate îngreuna scanarea. În cazul în care codul de bare nu este clar vizibil pentru dumneavoastră, este posibil ca nici camera să nu îl poată citi.",
        details_desktop: "Evitați lumina puternică directă, deoarece aceasta poate crea reflexii pe codul de bare și poate îngreuna scanarea. În cazul în care codul de bare nu este clar vizibil pentru dumneavoastră, este posibil ca nici camera să nu îl poată citi.",
        title: "Feriți-vă de lumina puternică",
        title_desktop: "Feriți-vă de lumina puternică",
      },
      visibility: {
        details: "Asigurați-vă că nu acoperiți cu degetul anumite părți ale codului de bare. De asemenea, aveți grijă la reflexiile care apar pe codul de bare și l-ar putea face ilizibil.",
        details_desktop: "Asigurați-vă că nu acoperiți cu degetul anumite părți ale codului de bare. De asemenea, aveți grijă la reflexiile care apar pe codul de bare și l-ar putea face ilizibil.",
    ...
    document_with_mrz: {
      ...
      visibility: {
        details: "Asigurați-vă că nu acoperiți cu degetul nicio parte a zonei MRZ. De asemenea, aveți grijă să nu se formeze reflexii peste zona MRZ, deoarece o pot face ilizibilă.",
        details_desktop: "Asigurați-vă că nu acoperiți cu degetul nicio parte a zonei MRZ. De asemenea, aveți grijă să nu se formeze reflexii peste zona MRZ, deoarece o pot face ilizibilă.",
  ...
  onboarding_modal: {
    ...
    barcode_only: {
      details: "Căutați un cod de bare (o serie de linii negre sau un cod în formă pătrată). Îndreptați camera spre acesta și țineți-o nemișcată — scanarea se va efectua automat.",
      details_desktop: "Căutați un cod de bare (o serie de linii negre sau un cod în formă pătrată). Asigurați-vă că obiectivul camerei este curat, iar codul de bare este bine iluminat.",
    ...
    document_with_barcode: {
      details: "Diversele tipuri de documente pot avea formate și amplasări diferite ale codului de bare. Priviți atât partea din față, cât și din spate a documentului pentru a localiza codul de bare.",
      details_desktop: "Priviți atât partea din față, cât și din spate a documentului pentru a localiza codul de bare. Asigurați-vă că obiectivul camerei este curat, iar documentul este bine iluminat.",
      title: "Găsiți codul de bare pe document",
      title_desktop: "Curățați obiectivul și localizați codul de bare",
    },
    document_with_mrz: {
      details: "Veți găsi un șir lung de caractere în partea de jos a documentului, pe fața sau pe spatele acestuia, întins pe 2 sau 3 rânduri și separat prin săgeți (<< sau >>).",
      details_desktop: "Priviți atât partea din față, cât și din spate a documentului pentru a localiza MRZ. Căutați 2-3 rânduri de caractere și simboluri de tip săgeată (<<) în partea de jos a documentului. Asigurați-vă că obiectivul camerei este curat, iar documentul este bine iluminat.",
      title: "Găsiți MRZ pe document",
      title_desktop: "Curățați obiectivul și localizați zona MRZ",
    },
    full_document: {
      details: "Asigurați-vă că documentul este bine iluminat. Toate secțiunile din document trebuie să fie vizibile pe ecranul camerei.",
  ...
  timeout_modal: {
    details: "Asigurați-vă că documentul este bine iluminat, vizibil în întregime și fără nicio reflexie.",
    details_desktop: "Asigurați-vă că obiectivul camerei este curat, iar documentul este vizibil în întregime, focalizat corect și bine iluminat.",
