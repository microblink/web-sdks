...
export default {
  ...
  document_filtered: "Document neacceptat",
  ...
  help_modal_done_btn: "Terminat",
  help_modal_next_btn: "Următorul",
  help_modal_title_1: "Asigurați vizibilitatea tuturor secțiunilor",
