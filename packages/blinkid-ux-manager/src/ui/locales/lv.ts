...
export default {
  ...
  help_modal: {
    ...
    barcode_only: {
      blur: {
        details: "Skenēšanas laikā nekustiniet tālruni un svītrkodu. Pretējā gadījumā attēls var būt izplūdis, un svītrkodu būs grūti nolasīt.",
        details_desktop: "Skenēšanas laikā centieties nekustēties. Pretējā gadījumā attēls var būt izplūdis, un svītrkodu būs grūti nolasīt.",
        title: "Skenēšanas laikā turēt nekustīgu",
        title_desktop: "Skenēšanas laikā turēt nekustīgu",
      },
      camera_lens: {
        details_desktop: "Pārbaudiet, vai uz kameras objektīva nav traipu vai putekļu. Netīrs objektīvs izraisa galīgā attēla izplūšanu, padarot svītrkodu nelasāmu un neļaujot sekmīgi skenēt datus.",
        title_desktop: "Notīriet kameras objektīvu",
      },
      lighting: {
        details: "Izvairieties no tiešas spilgtas gaismas, jo tā var radīt atspīdumu uz svītrkoda, un to būs grūti skenēt. Ja jūs skaidri nesaredzat svītrkodu, arī kamera to nevarēs nolasīt.",
        details_desktop: "Izvairieties no tiešas spilgtas gaismas, jo tā var radīt atspīdumu uz svītrkoda, un to būs grūti skenēt. Ja jūs skaidri nesaredzat svītrkodu, arī kamera to nevarēs nolasīt.",
        title: "Uzmanieties no spilgtas gaismas",
        title_desktop: "Uzmanieties no spilgtas gaismas",
      },
      visibility: {
        details: "Pārliecinieties, ka kādu svītrkoda daļu neaizsedzat ar pirkstu. Nodrošiniet arī, lai uz svītrkoda nebūtu atspīduma, jo šādā gadījumā svītrkods nebūs nolasāms.",
        details_desktop: "Pārliecinieties, ka kādu svītrkoda daļu neaizsedzat ar pirkstu. Nodrošiniet arī, lai uz svītrkoda nebūtu atspīduma, jo šādā gadījumā svītrkods nebūs nolasāms.",
    ...
    document_with_mrz: {
      ...
      visibility: {
        details: "Pārliecinieties, ka neaizsedzat daļu MRZ ar pirkstu. Pārbaudiet arī to, vai MRZ neietekmē atspīdumi, kas var neļaut to nolasīt.",
        details_desktop: "Pārliecinieties, ka neaizsedzat daļu MRZ ar pirkstu. Pārbaudiet arī to, vai MRZ neietekmē atspīdumi, kas var neļaut to nolasīt.",
        title: "Turiet dokumentu tā, lai būtu redzama MRZ",
        title_desktop: "Turiet dokumentu tā, lai būtu redzama MRZ",
      },
    },
    done_btn: "Gatavs",
  ...
  onboarding_modal: {
    ...
    barcode_only: {
      details: "Meklējiet svītrkodu (vairākas melnas līnijas vai kvadrātkodu). Vērsiet kameru pret to un nekustieties — skenēšana notiks automātiski.",
      details_desktop: "Meklējiet svītrkodu (vairākas melnas līnijas vai kvadrātkodu). Pārliecinieties, ka kameras objektīvs ir tīrs, un svītrkods ir labi apgaismots.",
      title: "Atrodiet un skenējiet svītrkodu",
      title_desktop: "Notīriet objektīvu un atrodiet svītrkodu",
    },
    btn: "Sāciet skenēšanu",
    document_with_barcode: {
      details: "Dažādiem dokumentiem var būt dažādi svītrkoda formāti un atrašanās vietas. Lai atrastu svītrkodu, aplūkojiet dokumenta priekšpusi un aizmuguri.",
      details_desktop: "Lai atrastu svītrkodu, pārbaudiet dokumenta priekšpusi un aizmuguri. Pārliecinieties, ka kameras objektīvs ir tīrs un dokuments ir labi apgaismots.",
      title: "Atrodiet dokumentā svītrkodu",
      title_desktop: "Notīriet objektīvu un atrodiet svītrkodu",
    },
    document_with_mrz: {
      details: "Dokumenta priekšpuses vai aizmugures apakšdaļā jūs atradīsiet garu virkni rakstzīmju, kas ir izvietota 2–3 rindās un sadalīta ar bultiņām (<< vai >>).",
      details_desktop: "Lai atrastu MRZ, pārbaudiet dokumenta priekšpusi un aizmuguri. Meklējiet dokumenta apakšdaļā 2-3 rindas rakstzīmju un bultiņu simbolu  (<<). Pārliecinieties, ka kameras objektīvs ir tīrs un dokuments ir labi apgaismots.",
  ...
  timeout_modal: {
    ...
    details_desktop: "Pārliecinieties, ka kameras objektīvs ir tīrs un dokuments ir pilnībā redzams, fokusā un labi apgaismots.",
