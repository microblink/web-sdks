...
export default {
  ...
  error_modal: {
    cancel_btn: "Cancelar digitalização",
  ...
  feedback_messages: {
    ...
    face_photo_not_fully_visible: "Mantenha a fotografia do rosto totalmente visível",
    ...
    scan_the_back_side: "Digitalize o verso de um documento",
    scan_the_barcode: "Digitalizar o código de barras",
    scan_the_barcode_side: "Digitalizar o lado do documento com um código de barras",
    scan_the_front_side: "Digitalize a parte da frente de um documento",
  ...
  help_modal: {
    ...
    barcode_only: {
      blur: {
        details: "Tente manter o telemóvel e o código de barras imóvel enquanto digitaliza, caso contrário a imagem poderá ficar desfocada e o código de barras poderá ficar desfocado e ser difícil de ler.",
        details_desktop: "Tente manter-se imóvel enquanto digitaliza, caso contrário o código de barras poderá ficar desfocado e ser difícil de ler.",
        title: "Mantenha-se imóvel enquanto digitaliza",
        title_desktop: "Mantenha-se imóvel enquanto digitaliza",
      },
      camera_lens: {
        details_desktop: "Verifique se não há manchas ou poeiras na lente da sua câmara. Uma lente suja torna a imagem final desfocada, tornando o código de barras ilegível e impedindo a digitalização correta dos dados.",
        title_desktop: "Limpe a lente da câmara",
      },
      lighting: {
        details: "Evite uma iluminação forte e direta, a qual poderá criar reflexos no código de barras e torná-lo difícil de digitalizar. Se o código de barras não for claramente visível, a câmara poderá também não conseguir digitalizá-lo.",
        details_desktop: "Evite uma iluminação forte e direta, a qual poderá criar reflexos no código de barras e torná-lo difícil de digitalizar. Se o código de barras não for claramente visível, a câmara poderá também não conseguir digitalizá-lo.",
        title: "Cuidado com a luz intensa",
        title_desktop: "Cuidado com a luz intensa",
      },
      visibility: {
        details: "Certifique-se de que não está a cobrir partes do código de barras com o dedo. Tenha também em atenção os reflexos sobre o código de barras e que poderão torná-lo ilegível.",
        details_desktop: "Certifique-se de que não está a cobrir partes do código de barras com o dedo. Tenha também em atenção os reflexos sobre o código de barras e que poderão torná-lo ilegível.",
    ...
    document_with_mrz: {
      ...
      visibility: {
        details: "Certifique-se de que não está a cobrir partes do MRZ com um dedo. Além disso, tenha em atenção os reflexos que se sobrepõem ao MRZ e que poderão torná-lo ilegível.",
        details_desktop: "Certifique-se de que não está a cobrir partes do MRZ com um dedo. Além disso, tenha em atenção os reflexos que se sobrepõem ao MRZ e que poderão torná-lo ilegível.",
  ...
  onboarding_modal: {
    ...
    barcode_only: {
      details: "Procure um código de barras (uma série de linhas pretas ou um código quadrado). Aponte a câmara e mantenha-a imóvel — a digitalização será efetuada automaticamente.",
      details_desktop: "Procure um código de barras (uma série de linhas pretas ou um código quadrado). Mantenha a lente da sua câmara limpa e o código de barras bem iluminado.",
    ...
    document_with_barcode: {
      details: "Diferentes tipos de documentos podem ter diferentes formatos e localizações de códigos de barras. Procure um código de barras na frente e no verso do documento.",
      details_desktop: "Procure um código de barras na frente e no verso do documento. Mantenha a lente da sua câmara limpa e o documento bem iluminado.",
      title: "Localize o código de barras no documento",
      title_desktop: "Limpe a lente e procure o código de barras",
    },
    document_with_mrz: {
      details: "Encontrará uma longa sequência de carateres na parte inferior da frente ou do verso do documento, dividida em 2 ou 3 linhas e separada por setas (<< ou >>).",
      details_desktop: "Procure um MRZ na frente e no verso do documento. Procure 2–3 linhas de caracteres e símbolos direcionais (<<) no fundo do documento. Certifique-se de que a lente da sua câmara esteja limpa e o documento bem iluminado.",
      title: "Localize o MRZ no documento",
      title_desktop: "Limpe a sua lente e localize o MRZ",
    },
    full_document: {
      details: "Assegure-se de que mantém o documento bem iluminado. Todos os campos do documento devem estar visíveis no ecrã da câmara.",
  ...
  timeout_modal: {
    details: "Garanta que o documento esteja bem iluminado, totalmente visível e sem reflexos.",
    details_desktop: "Garanta que a lente da sua câmara esteja limpa e o documento totalmente visível, focado e bem iluminado.",
