...
export default {
  ...
  document_filtered: "Hindi tinanggap ang dokumento",
  document_filtered_details: "Subukang mag-scan ng ibang dokumento.",
  ...
  help_modal_done_btn: "Tapos na",
  help_modal_next_btn: "Susunod",
  help_modal_title_1: "Panatilihing nakikita ang lahat ng field",
