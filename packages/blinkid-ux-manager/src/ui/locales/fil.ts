...
export default {
  ...
  feedback_messages: {
    blur_detected: "Panatilihing nakapirmi ang dokumento at telepono",
    camera_angle_too_steep: "Panatilihing parallel ang dokumento sa telepono",
    document_scanned_aria: "Tagumpay! Na-scan ang dokumento",
    document_too_close_to_edge: "Ilayo pa",
    face_photo_not_fully_visible: "Panatilihing ganap na nakikita ang larawan ng mukha",
    ...
    glare_detected: "Ikiling o ilipat ang dokumento upang alisin ang repleksiyon",
    keep_document_parallel: "Panatilihing parallel ang dokumento sa screen",
  ...
  help_modal: {
    ...
    barcode_only: {
      blur: {
        details: "Panatilihing hindi gumagalaw ang telepono at barcode habang nag-i-scan. Maaaring maging malabo ang larawan at hindi mabasa ang barcode kapag gumagalaw.",
        details_desktop: "Panatilihing hindi gumagalaw habang nag-i-scan. Maaaring maging malabo ang larawan at hindi mabasa ang barcode kapag gumagalaw.",
        title: "Panatilihing hindi gumagalaw habang nag-i-scan",
        title_desktop: "Panatilihing hindi gumagalaw habang nag-i-scan",
      },
      camera_lens: {
        details_desktop: "Suriin kung may mga mantsa o alikabok ang lens ng camera mo. Nagdudulot ng paglabo ng pinal na larawan ang maruruming lens, na dahilan para hindi mabasa ang barcode at hindi ma-scan ang data.",
        title_desktop: "Linisin ang mga lens ng camera mo",
      },
      lighting: {
        details: "Iwasan ang direktang nakakasilaw na ilaw dahil maaari itong magdulot ng sinag sa barcode at magiging mahirap ang pag-scan. Kung hindi mo malinaw na nakikita ang barcode, posibleng hindi rin ito nababasa ng camera.",
        details_desktop: "Iwasan ang direktang nakakasilaw na ilaw dahil maaari itong magdulot ng sinag sa barcode at magiging mahirap ang pag-scan. Kung hindi mo malinaw na nakikita ang barcode, posibleng hindi rin ito nababasa ng camera.",
        title: "Tingnan kung may nakakasilaw na liwanag",
        title_desktop: "Tingnan kung may nakakasilaw na liwanag",
      },
      visibility: {
        details: "Siguradhing hindi mo natatakpan ng daliri ang mga bahagi ng barcode. Tingnan din kung may mga reflection sa barcode na dahilan para hindi mabasa ito.",
        details_desktop: "Siguradhing hindi mo natatakpan ng daliri ang mga bahagi ng barcode. Tingnan din kung may mga reflection sa barcode na dahilan para hindi mabasa ito.",
    ...
    document_with_mrz: {
      ...
      visibility: {
        details: "Siguradhing hindi mo natatakpan ng daliri ang mga bahagi ng MRZ. Tingnan din kung may mga reflection sa MRZ na dahilan para hindi mabasa ito.",
        details_desktop: "Siguradhing hindi mo natatakpan ng daliri ang mga bahagi ng MRZ. Tingnan din kung may mga reflection sa MRZ na dahilan para hindi mabasa ito.",
  ...
  onboarding_modal: {
    ...
    barcode_only: {
      details: "Hanapin ang barcode (isang series ng itim na linya o parisukat na code). Itutok ang camera mo dito at panatilihing hindi gumagalaw  — awtomatikong mangyayari ang pag-scan.",
      details_desktop: "Hanapin ang barcode (isang series ng itim na linya o parisukat na code). Siguraduhing malinis ang lens ng camera mo at lubos na naiilawan ang barcode.",
      title: "Hanapin at i-scan ang barcode",
      title_desktop: "Linisin ang lens mo at hanapin ang barcode",
    },
    btn: "Simulan ang Pag-scan",
    document_with_barcode: {
      details: "Maaaring may iba't ibang format at lokasyon ng barcode ang iba't ibang uri ng mga dokumento. Tingnan ang harap at likod ng dokumento para sa barcode.",
      details_desktop: "Tingnan ang harap at likod ng dokumento para sa barcode. Siguraduhing malinis ang lens ng camera mo at sapat na naiilawan ang dokumento.",
      title: "Hanapin ang barcode sa dokumento",
      title_desktop: "Linisin ang lens mo at hanapin ang barcode",
    },
    document_with_mrz: {
      details: "Makakakita ka ng mahabang string ng mga character sa ibaba ng harap o likod ng dokumento. Nahahati ito sa 2 o 3 linya at pinaghihiwalay ng mga arrow (<< o >>).",
      details_desktop: "Tingnan ang harap at likod ng dokumento para sa MRZ. Hanapin ang 2–3 linya ng mga character at mga simbolo ng arrow  (<<) sa ibaba ng dokumento. Siguraduhing malinis ang lens ng camera mo at sapat na naiilawan ang dokumento.",
      title: "Hanapin ang MRZ sa dokumento",
      title_desktop: "Linisin ang lens mo at hanapin ang MRZ",
    },
    full_document: {
      details: "Tiyaki na lubos na naiilawan ang dokumento. Dapat nakikita sa screen ng camera ang lahat ng field ng dokumento.",
  ...
  timeout_modal: {
    details: "Siguraduhing sapat na naiilawan ang dokumento, ganap na nakikita, at walang glare.",
    details_desktop: "Siguraduhing malinis ang lens ng camera mo at ganap na nakikita ang dokumento, naka-focus, at sapat na naiilawan.",
