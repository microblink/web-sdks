...
export default {
  ...
  feedback_messages: {
    blur_detected: "Håll dokumentet och telefonen stilla",
    ...
    face_photo_not_fully_visible: "Håll ansiktsfotot helt synligt",
    flip_document: "Vänd på dokumentet",
    flip_to_back_side: "Vänd till baksidan",
    front_side_scanned_aria: "Lyckades! Framsidan skannad",
    glare_detected: "Luta eller flytta dokumentet för att undvika reflexer",
    ...
    scan_the_back_side: "Skanna baksidan av ett dokument",
    scan_the_barcode: "Skanna streckkoden",
    scan_the_barcode_side: "Skanna streckkodssidan av ett dokument",
    scan_the_front_side: "Skanna framsidan av ett dokument",
  ...
  help_modal: {
    ...
    barcode_only: {
      blur: {
        details: "Försök att hålla telefonen och streckkoden stilla medan du skannar. Att röra sig kan göra bilden suddig och göra streckkoden svår att läsa.",
        details_desktop: "Försök att stå stilla medan du skannar. Rörelse kan göra bilden suddig och göra streckkoden svår att läsa.",
        title: "Håll stilla medan du skannar",
        title_desktop: "Håll stilla medan du skannar",
      },
      camera_lens: {
        details_desktop: "Kontrollera kameralinsen för fläckar eller damm. En smutsig lins gör att den slutliga bilden blir suddig, vilket gör streckkoden oläslig och förhindrar att informationen skannas.",
        title_desktop: "Rengör kameralinsen",
      },
      lighting: {
        details: "Undvik direkt starkt ljus eftersom det kan skapa reflektioner på streckkoden och göra den svår att skanna. Om streckkoden inte är tydligt synlig för dig kanske kameran inte heller kan läsa den.",
        details_desktop: "Undvik direkt starkt ljus eftersom det kan skapa reflektioner på streckkoden och göra den svår att skanna. Om streckkoden inte är tydligt synlig för dig kanske kameran inte heller kan läsa den.",
        title: "Se upp för skarpt ljus",
        title_desktop: "Se upp för skarpt ljus",
      },
      visibility: {
        details: "Se till att du inte täcker delar av streckkoden med fingret. Se också upp för reflektioner som går över streckkoden och kan göra den oläslig.",
        details_desktop: "Se till att du inte täcker delar av streckkoden med fingret. Se också upp för reflektioner som går över streckkoden och kan göra den oläslig.",
    ...
    document_with_mrz: {
      ...
      visibility: {
        details: "Kontrollera att du inte täcker delar av MRZ-koden med ett finger. Se också upp för reflektioner som kan göra MRZ-koden oläslig.",
        details_desktop: "Kontrollera att du inte täcker delar av MRZ-koden med ett finger. Se också upp för reflektioner som kan göra MRZ-koden oläslig.",
  ...
  onboarding_modal: {
    ...
    barcode_only: {
      details: "Leta efter en streckkod (en serie svarta linjer eller en fyrkantig kod). Rikta kameran mot den och håll den stilla – skanningen sker automatiskt.",
      details_desktop: "Leta efter en streckkod (en serie svarta linjer eller en fyrkantig kod). Se till att hålla kameralinsen ren och streckkoden väl upplyst.",
      title: "Leta reda på och skanna streckkoden",
      title_desktop: "Rengör linsen och leta reda på streckkoden",
    },
    btn: "Börja skanna",
    document_with_barcode: {
      details: "Olika typer av dokument kan ha olika streckkodsformat, och placeringen kan variera. Titta på båda sidorna av dokumentet för att hitta streckkoden.",
      details_desktop: "Leta efter streckkoden på båda sidorna av dokumentet. Kontrollera att kameralinsen är ren och att dokumentet är väl belyst.",
      title: "Leta reda på dokumentets streckkod",
      title_desktop: "Rengör linsen och leta reda på streckkoden",
    },
    document_with_mrz: {
      details: "Längst ner på dokumentets fram- eller baksida finns två eller tre rader med tecken som separeras av pilar (<< eller >>).",
      details_desktop: "Längst ner på dokumentets fram- eller baksida finns MRZ-koden, som består av två eller tre rader med tecken och pilar (<< ). Kontrollera att kameralinsen är ren och att dokumentet är väl belyst.",
      title: "Leta reda på dokumentets MRZ-kod",
      title_desktop: "Rengör kameralinsen och leta reda på MRZ-koden",
    },
    full_document: {
      details: "Se till att dokumentet är väl belyst. Alla fält i dokumentet ska synas på kameraskärmen.",
  ...
  timeout_modal: {
    details: "Kontrollera att belysningen är god och att hela dokumentet är synligt och fritt från reflektioner.",
    details_desktop: "Kontrollera att kameralinsen är ren och att hela dokumentet är synligt, i fokus och väl belyst.",
