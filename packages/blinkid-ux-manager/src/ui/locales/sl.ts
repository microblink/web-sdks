...
export default {
  ...
  feedback_messages: {
    blur_detected: "Dokument in telefon držite pri miru",
    camera_angle_too_steep: "Dokument držite vzporedno s telefonom",
    ...
    keep_document_parallel: "Dokument držite vzporedno z zaslonom",
    ...
    scan_the_mrz_side: "Skenirajte stran dokumenta s strojno berljivim območjem",
  ...
  help_modal: {
    ...
    barcode_only: {
      blur: {
        details: "Med skeniranjem poskusite telefon in črtno kodo držati pri miru. Premikanje lahko zamegli sliko in oteži branje črtne kode.",
        details_desktop: "Poskusite med skeniranjem ostati pri miru. Premikanje lahko zamegli sliko in oteži branje črtne kode.",
        title: "Držite pri miru med optičnim branjem",
        title_desktop: "Držite pri miru med optičnim branjem",
      },
      camera_lens: {
        details_desktop: "Preverite, ali so na objektivu kamere madeži ali prah. Umazan objektiv lahko povzroči zamegljeno sliko, zaradi česar črtne kode ni mogoče prebrati in podatkov ni mogoče uspešno skenirati.",
        title_desktop: "Očistite objektiv kamere",
      },
      lighting: {
        details: "Izogibajte se močni neposredni svetlobi, saj lahko povzroči bleščanje na črtni kodi in oteži skeniranje. Če črtna koda ni jasno vidna vam, je morda tudi kamera ne bo mogla prebrati.",
        details_desktop: "Izogibajte se močni neposredni svetlobi, saj lahko povzroči bleščanje na črtni kodi in oteži skeniranje. Če črtna koda ni jasno vidna vam, je morda tudi kamera ne bo mogla prebrati.",
        title: "Svetloba ne sme biti premočna",
        title_desktop: "Svetloba ne sme biti premočna",
      },
      visibility: {
        details: "Prepričajte se, da s prstom ne prekrivate delov črtne kode. Pazite tudi na odseve, ki prekrivajo črtno kodo in jo lahko naredijo nečitljivo.",
        details_desktop: "Prepričajte se, da s prstom ne prekrivate delov črtne kode. Pazite tudi na odseve, ki prekrivajo črtno kodo in jo lahko naredijo nečitljivo.",
    ...
    document_with_mrz: {
      ...
      visibility: {
        details: "Ne prekrivajte nobenega dela strojno berljivega območja s prstom. Prav tako bodite pozorni na odseve svetlobe na strojno berljivem območju, zaradi katerih bi lahko postalo neberljivo.",
        details_desktop: "Ne prekrivajte nobenega dela strojno berljivega območja s prstom. Prav tako bodite pozorni na odseve svetlobe na strojno berljivem območju, zaradi katerih bi lahko postalo neberljivo.",
  ...
  onboarding_modal: {
    ...
    barcode_only: {
      details: "Poiščite črtno kodo (niz črnih črt ali kvadratno kodo). Usmerite kamero vanjo in mirujte — skeniranje se bo začelo samodejno.",
      details_desktop: "Poiščite črtno kodo (niz črnih črt ali kvadratno kodo). Poskrbite, da bo objektiv kamere čist in da bo črtna koda dobro osvetljena.",
    ...
    document_with_barcode: {
      details: "Različne vrste dokumentov imajo lahko različne oblike črtnih kod, ki so lahko na različnih mestih. Poiščite črtno kodo na sprednji ali zadnji strani dokumenta.",
      details_desktop: "Preverite, ali je na sprednji ali zadnji strani dokumenta črtna koda. Poskrbite, da bo objektiv kamere čist in da bo dokument dobro osvetljen.",
      title: "Poiščite črtno kodo na dokumentu",
      title_desktop: "Očistite objektiv kamere in poiščite črtno kodo",
    },
    document_with_mrz: {
      details: "Na spodnjem delu sprednje ali zadnje strani dokumenta boste našli dolg niz znakov, razdeljen v dve ali tri vrstice ter ločen s puščicami (<< ali >>).",
      details_desktop: "Na sprednji in zadnji strani dokumenta preverite, ali vključuje strojno berljivo območje. Na spodnjem delu dokumenta poiščite dve ali tri vrstice znakov in simbolov (<<). Poskrbite, da bo objektiv kamere čist in da bo dokument dobro osvetljen.",
      title: "Poiščite strojno berljivo območje na dokumentu",
      title_desktop: "Očistite objektiv kamere in poiščite strojno berljivo območje",
    },
    full_document: {
      details: "Poskrbite, da bo dokument dobro osvetljen. Na zaslonu kamere morajo biti vidna vsa polja dokumenta.",
  ...
  timeout_modal: {
    details: "Poskrbite, da bo dokument dobro osvetljen, v celoti viden in brez odsevov.",
    details_desktop: "Poskrbite, da bo objektiv kamere čist ter da bo dokument v celoti viden, izostren in dobro osvetljen.",
