...
export default {
  ...
  feedback_messages: {
    blur_detected: "Belgeyi ve telefonu sabit tutun",
    camera_angle_too_steep: "Belgeyi telefona paralel tutun",
    document_scanned_aria: "Başarılı! Belge tarandı",
    document_too_close_to_edge: "Uzaklaş",
    face_photo_not_fully_visible: "Yüz fotoğrafını tamamen görünür tutun",
    flip_document: "Belgeyi çevir",
    flip_to_back_side: "Arka tarafa çevir",
    front_side_scanned_aria: "Başarılı! Ön taraf tarandı",
    glare_detected: "Yansımayı gidermek için belgeyi eğin veya hareket ettirin",
    ...
    scan_the_back_side: "Belgenin arka yüzünü tarayın",
    scan_the_barcode: "Barkodu tara",
    scan_the_barcode_side: "Belgenin barkodlu tarafını tarayın",
    scan_the_front_side: "Belgenin ön yüzünü tarayın",
  ...
  help_modal: {
    ...
    barcode_only: {
      blur: {
        details: "Tarama sırasında telefonu ve barkodu sabit tutmaya özen gösterin. Herhangi birinin hareket etmesi görüntüyü bulanıklaştırıp barkodun okunmasını zorlaştırabilir.",
        details_desktop: "Tarama yaparken sabit durmaya çalışın. Hareket etmek görüntüyü bulanıklaştırabilir ve barkodun okunmasını zorlaştırabilir.",
        title: "Tarama sırasında hareketsiz kal",
        title_desktop: "Tarama sırasında hareketsiz kal",
      },
      camera_lens: {
        details_desktop: "Kamera lensinizde leke veya toz olup olmadığını kontrol edin. Kirli bir lens görüntünün bulanıklaşmasına neden olarak barkodu okunmaz hale getirir ve verinin başarıyla taranmasını engeller.",
        title_desktop: "Kamera lenslerinizi temizleyin",
      },
      lighting: {
        details: "Doğrudan ve yoğun ışıktan kaçının; bu durum barkodun üzerinde parlama yaparak taranmasını zorlaştırır. Eğer barkod gözünüze net görünmüyorsa, büyük ihtimalle kamera da okuyamayacaktır.",
        details_desktop: "Doğrudan ve yoğun ışıktan kaçının; bu durum barkodun üzerinde parlama yaparak taranmasını zorlaştırır. Eğer barkod gözünüze net görünmüyorsa, büyük ihtimalle kamera da okuyamayacaktır.",
        title: "Sert ışığa dikkat et",
        title_desktop: "Sert ışığa dikkat et",
      },
      visibility: {
        details: "Barkodun hiçbir bölümünü parmağınızla kapatmadığınızdan emin olun. Ayrıca, barkodun üzerinde parlayarak okunmasını engelleyebilecek ışık yansımalarına da dikkat edin.",
        details_desktop: "Barkodun hiçbir bölümünü parmağınızla kapatmadığınızdan emin olun. Ayrıca, barkodun üzerinde parlayarak okunmasını engelleyebilecek ışık yansımalarına da dikkat edin.",
    ...
    document_with_mrz: {
      ...
      visibility: {
        details: "MRZ'nin herhangi bir bölümünü parmağınızla kapatmadığınızdan emin olun. Ayrıca MRZ'nin okunması engelleyebilecek yansımalara dikkat edin.",
        details_desktop: "MRZ'nin herhangi bir bölümünü parmağınızla kapatmadığınızdan emin olun. Ayrıca MRZ'nin okunması engelleyebilecek yansımalara dikkat edin.",
  ...
  onboarding_modal: {
    ...
    barcode_only: {
      details: "Bir barkod (yan yana siyah çizgiler veya bir karekod) bulun. Kameranızı barkoda doğru tutup sabit bekleyin; tarama otomatik olarak yapılacaktır.",
      details_desktop: "Bir barkod (siyah çizgilerden oluşan bir dizi veya bir karekod) arayın. Kamera lensinizin temiz ve barkodun iyi aydınlatılmış olduğundan emin olun.",
      title: "Barkodu bulun ve tarayın",
      title_desktop: "Kamera lensinizi temizleyin ve barkodu bulun",
    },
    btn: "Taramayı Başlat",
    document_with_barcode: {
      details: "Farklı belge türlerinde barkod biçimleri ve yerleri farklı olabilir. Barkodu bulmak için belgenin ön ve arka yüzüne bakın.",
      details_desktop: "Belgede barkod olup olmadığını kontrol etmek için belgenin ön ve arka yüzüne bakın. Kamera lensinizin temiz ve belgenin iyi aydınlatılmış olmasına dikkat edin.",
      title: "Belgede barkodu bulun",
      title_desktop: "Kamera lensinizi temizleyin ve barkodu bulun",
    },
    document_with_mrz: {
      details: "Belgenin ön veya arka yüzünün alt kısmında 2 veya 3 satıra ayrılmış ve oklarla (<< veya >>) ayrılmış uzun bir karakter dizisi göreceksiniz.",
      details_desktop: "Belgede MRZ olup olmadığını kontrol etmek için belgenin ön ve arka yüzüne bakın. Belgenin alt kısmında 2-3 satırdan oluşan karakterleri ve ok sembollerini (<<) bulun. Kamera lensinizin temiz ve belgenin iyi aydınlatılmış olmasına dikkat edin.",
      title: "Belgede MRZ'yi bulun",
      title_desktop: "Lensinizi temizleyin ve MRZ'yi bulun",
    },
    full_document: {
      details: "Belgenin iyi aydınlatıldığından emin ol. Tüm belge alanları kamera ekranında görünür olmalıdır.",
  ...
  timeout_modal: {
    details: "Belgenin iyi aydınlatılmış ve tamamen görünür olmasına ve belge üzerinde bir parlama olmamasına dikkat edin.",
    details_desktop: "Kamera lensinizin temiz ve belgenin tamamen görünür, odakta ve iyi aydınlatılmış olmasına dikkat edin.",
