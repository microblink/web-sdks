...
export default {
  ...
  feedback_messages: {
    blur_detected: "Haltu skjalinu og símanum kyrrum",
    camera_angle_too_steep: "Haltu skjalinu samsíða símanum",
    document_scanned_aria: "Tókst! Skjalið var skannað",
    document_too_close_to_edge: "Færið fjær",
    face_photo_not_fully_visible: "Haltu andlitsmyndinni að fullu sýnilegri",
    flip_document: "Snúið skjalinu",
    flip_to_back_side: "Snúið á bakhliðina",
    front_side_scanned_aria: "Tókst! Framhlið skönnuð",
    glare_detected: "Hallaðu eða færðu skjalið til að fjarlægja endurkast",
    keep_document_parallel: "Haltu skjalinu samsíða skjánum",
  ...
  help_modal: {
    ...
    barcode_only: {
      blur: {
        details: "Reyndu að halda símanum og strikamerkinu kyrru meðan þú skannar. Ef annað hvort hreyfist getur myndin orðið óskýr og strikamerkið orðið erfitt að lesa.",
        details_desktop: "Reyndu að halda kyrru á meðan skannað er. Hreyfing getur gert myndina óskýra og gert strikamerkið erfitt að lesa.",
        title: "Verið kyrr á meðan skannað er",
        title_desktop: "Verið kyrr á meðan skannað er",
      },
      camera_lens: {
        details_desktop: "Athugaðu hvort blettir eða ryk séu á myndavélarlinsunni. Óhrein linsa veldur því að lokamyndin verður óskýr, sem gerir strikamerkið ólæsilegt og kemur í veg fyrir að hægt sé að skanna gögnin með góðum árangri.",
        title_desktop: "Hreinsið myndavélalinsuna",
      },
      lighting: {
        details: "Forðastu beint skarpt ljós, því það getur valdið glampa á strikamerkinu og gert það erfitt að skanna. Ef þú sérð strikamerkið ekki greinilega, gæti myndavélin einnig átt erfitt með að lesið það.",
        details_desktop: "Forðastu beint skarpt ljós, því það getur valdið glampa á strikamerkinu og gert það erfitt að skanna. Ef þú sérð strikamerkið ekki greinilega, gæti myndavélin einnig átt erfitt með að lesið það.",
        title: "Gætið að sterku ljósi",
        title_desktop: "Gætið að sterku ljósi",
      },
      visibility: {
        details: "Gakktu úr skugga um að þú hyljir ekki hluta strikamerkisins með fingri. Gáðu einnig að endurkasti ljóss sem fer yfir strikamerkið og gæti gert það ólæsilegt.",
        details_desktop: "Gakktu úr skugga um að þú hyljir ekki hluta strikamerkisins með fingri. Gáðu einnig að endurkasti ljóss sem fer yfir strikamerkið og gæti gert það ólæsilegt.",
    ...
    document_with_mrz: {
      ...
      visibility: {
        details: "Gakktu úr skugga um að þú hyljir ekki hluta af véllesanlega svæðinu með fingri. Passaðu þig líka á endurskinsljósi sem fellur yfir véllesanlega svæðið og gæti gert það ólæsilegt.",
        details_desktop: "Gakktu úr skugga um að þú hyljir ekki hluta af véllesanlega svæðinu með fingri. Passaðu þig líka á endurskinsljósi sem fellur yfir véllesanlega svæðið og gæti gert það ólæsilegt.",
  ...
  onboarding_modal: {
    ...
    barcode_only: {
      details: "Leitaðu að strikamerki (röð af svörtum línum eða ferköntuðum kóða). Beindu myndavélinni að því og haltu henni kyrrri — skönnun fer fram sjálfkrafa.",
      details_desktop: "Leitaðu að strikamerki (röð af svörtum línum eða ferköntuðum kóða). Gakktu úr skugga um að linsan á myndavélinni sé hrein og að strikamerkið sé vel upplýst.",
      title: "Finndu og skannaðu strikamerkið",
      title_desktop: "Hreinsaðu myndavélarlinsuna og finndu strikamerkið",
    },
    btn: "Byrja að skanna",
    document_with_barcode: {
      details: "Mismunandi gerðir skjala geta haft mismunandi strikamerkjasnið og staðsetningar. Leitaðu að strikamerki á fram- og bakhlið skjalsins.",
      details_desktop: "Athugaðu fram- og bakhlið skjalsins hvort þar sé strikamerki. Gakktu úr skugga um að linsa myndavélarinnar sé hrein og skjalið vel upplýst.",
      title: "Finndu strikamerki skjalsins",
      title_desktop: "Hreinsaðu myndavélarlinsuna og finndu strikamerkið",
    },
    document_with_mrz: {
      details: "Þú finnur langa röð af táknum neðst á forsíðu eða bakhlið skjalsins, skipt í 2 eða 3 línur og aðskilin með örvum (&lt;&lt; eða &gt;&gt;).",
      details_desktop: "Athugaðu fram- og bakhlið skjalsins hvort þar sé véllesanlegt svæði. Leitaðu að 2–3 línum af stöfum og örvatáknum (<<) neðst á skjalinu. Gakktu úr skugga um að linsa myndavélarinnar sé hrein og skjalið vel upplýst.",
      title: "Finndu véllesanlega svæði skjalsins",
      title_desktop: "Hreinsaðu linsuna og finndu véllesanlega svæðið",
    },
    full_document: {
      details: "Gangið úr skugga um að skjalið sé vel lýst. Allir reitir skjals ættu að vera sýnilegir á skjá myndavélarinnar.",
  ...
  timeout_modal: {
    details: "Gakktu úr skugga um að skjalið sé vel upplýst, fulllega sýnilegt og laust við endurskin.",
    details_desktop: "Gakktu úr skugga um að myndavélarlinsан sé hrein og skjalið sé fullkomlega sýnilegt, í fókus og vel upplýst.",
