...
export default {
  ...
  feedback_messages: {
    blur_detected: "Držte dokument aj telefón bez pohybu",
    camera_angle_too_steep: "Držte dokument rovnobežne s telefónom",
    document_scanned_aria: "Úspech! Doklad bol naskenovaný",
    document_too_close_to_edge: "Posuňte sa ďalej",
    face_photo_not_fully_visible: "Udržujte fotografiu tváre úplne viditeľnú",
    ...
    keep_document_parallel: "Držte dokument rovnobežne s obrazovkou",
    ...
    scan_the_mrz_side: "Naskenujte stranu dokumentu so strojovo čitateľnou oblasťou (MRZ)",
  ...
  help_modal: {
    ...
    barcode_only: {
      blur: {
        details: "Počas snímania sa snažte nehýbať telefónom a čiarovým kódom. Pohyb môže rozmazať obraz a spôsobiť, že sa čiarový kód nebude dať prečítať.",
        details_desktop: "Počas snímania sa snažte nehýbať. Pohyb môže rozmazať obraz a spôsobiť, že sa čiarový kód nebude dať prečítať.",
        title: "Počas snímania zostaňte v pokoji",
        title_desktop: "Počas snímania zostaňte v pokoji",
      },
      camera_lens: {
        details_desktop: "Skontrolujte, či na objektíve kamery nie sú šmuhy alebo prach. Ak je objektív znečistený, výsledný obraz bude rozmazaný, čiarový kód nečitateľný a snímanie údajov sa nepodarí.",
        title_desktop: "Vyčistite objektív kamery",
      },
      lighting: {
        details: "Vyhnite sa priamemu ostrému svetlu, pretože môže na čiarovom kóde vytvoriť odlesky a sťažiť jeho snímanie. Ak vy nevidíte jasne čiarový kód, nebude ho vidieť ani kamera.",
        details_desktop: "Vyhnite sa priamemu ostrému svetlu, pretože môže na čiarovom kóde vytvoriť odlesky a sťažiť jeho snímanie. Ak vy nevidíte jasne čiarový kód, nebude ho vidieť ani kamera.",
        title: "Pozor na ostré svetlo",
        title_desktop: "Pozor na ostré svetlo",
      },
      visibility: {
        details: "Uistite sa, že časti čiarového kódu nezakrývate prstom. Dávajte si tiež pozor na odrazy, ktoré prechádzajú cez čiarový kód a môžu spôsobiť, že bude nečitateľný.",
        details_desktop: "Uistite sa, že časti čiarového kódu nezakrývate prstom. Dávajte si tiež pozor na odrazy, ktoré prechádzajú cez čiarový kód a môžu spôsobiť, že bude nečitateľný.",
    ...
    document_with_mrz: {
      ...
      visibility: {
        details: "Uistite sa, že časti strojovo čitateľnej oblasti (MRZ) nezakrývate prstom. Dávajte si tiež pozor na odrazy, ktoré prechádzajú cez túto oblasť a môžu spôsobiť, že bude nečitateľná.",
        details_desktop: "Uistite sa, že časti strojovo čitateľnej oblasti (MRZ) nezakrývate prstom. Dávajte si tiež pozor na odrazy, ktoré prechádzajú cez túto oblasť a môžu spôsobiť, že bude nečitateľná.",
  ...
  onboarding_modal: {
    ...
    barcode_only: {
      details: "Vyhľadajte čiarový kód (sériu čiernych čiar alebo štvorcový kód). Nasmerujte naň fotoaparát a nehýbte sa – snímanie prebehne automaticky.",
      details_desktop: "Vyhľadajte čiarový kód (sériu čiernych čiar alebo štvorcový kód). Uistite sa, že je objektív fotoaparátu čistý a čiarový kód dobre osvetlený.",
    ...
    document_with_barcode: {
      details: "Rôzne typy dokumentov môžu mať rôzne formáty a umiestnenia čiarových kódov. Vyhľadajte čiarový kód na prednej alebo zadnej strane dokumentu.",
      details_desktop: "Skontrolujte, či je na prednej a zadnej strane dokumentu čiarový kód. Uistite sa, že je objektív fotoaparátu čistý a dokument dobre osvetlený.",
      title: "Nájdite na dokumente čiarový kód",
      title_desktop: "Vyčistite objektív kamery a nájdite čiarový kód",
    },
    document_with_mrz: {
      details: "V spodnej časti prednej alebo zadnej strany dokumentu nájdete dlhý reťazec znakov. Je rozdelená na 2 alebo 3 riadky a oddelená šípkami (<< alebo >>).",
      details_desktop: "Skontrolujte, či je na prednej a zadnej strane dokumentu strojovo čitateľná oblasť (MRZ). Vyhľadajte 2 až 3 riadky znakov a symboly šípok (<<) na spodnej strane dokumentu. Uistite sa, že je objektív fotoaparátu čistý a dokument dobre osvetlený.",
      title: "Nájdite na dokumente strojovo čitateľnú oblasť (MRZ)",
      title_desktop: "Vyčistite objektív kamery a nájdite strojovo čitateľnú oblasť",
    },
    full_document: {
      details: "Uistite sa, že máte dokument dobre osvetlený. Všetky polia dokumentu by mali byť viditeľné na obrazovke fotoaparátu.",
  ...
  timeout_modal: {
    details: "Uistite sa, že je dokument dobre osvetlený, plne viditeľný a bez odleskov.",
    details_desktop: "Uistite sa, že objektív fotoaparátu je čistý a dokument je plne viditeľný, zaostrený a dobre osvetlený.",
