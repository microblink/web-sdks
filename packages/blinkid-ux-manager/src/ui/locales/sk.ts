...
export default {
  ...
  document_filtered: "Dokument nebol prijatý",
  document_filtered_details: "Skúste naskenovať iný dokument.",
  ...
  help_modal_next_btn: "Ďalej",
  help_modal_title_1: "Udržujte všetky polia viditeľné",
