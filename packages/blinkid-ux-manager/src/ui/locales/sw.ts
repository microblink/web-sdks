...
export default {
  ...
  error_modal: {
    cancel_btn: "Ghairi utambazaji",
    retry_btn: "Jaribu tena",
  },
  feedback_messages: {
    blur_detected: "Usisogeze hati wala simu",
    camera_angle_too_steep: "Weka hati sambamba na simu",
    document_scanned_aria: "Imemaliza! Hati imeskaniwa",
    document_too_close_to_edge: "Songa mbali",
    face_photo_not_fully_visible: "Hakikisha picha ya uso inaonekana kikamilifu",
    ...
    glare_detected: "Inamisha au sogeza hati ili kuondoa mng'ao",
    keep_document_parallel: "Weka hati sambamba na skrini",
  ...
  help_modal: {
    ...
    barcode_only: {
      blur: {
        details: "Jaribu kuhakikisha simu na msimbopau havisongi unaposkani. Kusonga kunaweza kufanya picha isionekane vizuri na kufanya iwe vigumu msimbopau kusomeka.",
        details_desktop: "Jaribu kuhakikisha haisongi unaposkani. Kusonga kunaweza kufanya picha isionekane vizuri na kufanya iwe vigumu msimbopau kusomeka.",
        title: "Usisonge unaposkani",
        title_desktop: "Usisonge unaposkani",
      },
      camera_lens: {
        details_desktop: "Angalia lenzi ya kamera yako kama ina uchafu au madoa. Lenzi chafu hufanya picha ya mwisho isionekane vizuri, na kufanya msimbopau usiweze kusomeka na kuzuia data kuskanikiwa vizuri.",
        title_desktop: "Safisha lenzi ya kamera yako",
      },
      lighting: {
        details: "Epuka mwanga mkali wa moja kwa moja kwa sababu unaweza kusababisha mng'ao mkali kwenye msimbopau na kufanya iwe vigumu kuskani. Kama huoni vizuri msimbopau, kamera vilevile huenda isiweze kuusoma.",
        details_desktop: "Epuka mwanga mkali wa moja kwa moja kwa sababu unaweza kusababisha mng'ao mkali kwenye msimbopau na kufanya iwe vigumu kuskani. Kama huoni vizuri msimbopau, kamera vilevile huenda isiweze kuusoma.",
        title: "Kuwa mwangalifu na mwanga mkali",
        title_desktop: "Kuwa mwangalifu na mwanga mkali",
      },
      visibility: {
        details: "Hakikisha hujafunika sehemu za msimbopau kwa kidole. Pia, kuwa mwangalifu na mwanga unaoakisiwa unaopita juu ya msimbopau na unaweza kuufanya usisomeke.",
        details_desktop: "Hakikisha hujafunika sehemu za msimbopau kwa kidole. Pia, kuwa mwangalifu na mwanga unaoakisiwa unaopita juu ya msimbopau na unaweza kuufanya usisomeke.",
        title: "Hakikisha msimbopau unaonekana",
    ...
    document_with_mrz: {
      ...
      visibility: {
        details: "Hakikisha hujafunika sehemu za MRZ kwa kidole. Pia, kuwa mwangalifu na mwanga unaoakisiwa unaopita juu ya MRZ na unaweza kuufanya isisomeke.",
        details_desktop: "Hakikisha hujafunika sehemu za MRZ kwa kidole. Pia, kuwa mwangalifu na mwanga unaoakisiwa unaopita juu ya MRZ na unaweza kuufanya isisomeke.",
  ...
  onboarding_modal: {
    ...
    barcode_only: {
      details: "Tafuta msimbopau (mfululizo wa mistari mieusi au msimbo mraba). Uelekezee kamera yako na uhakikishe haisongi — shughuli ya kuskani itafanyika kiotomatiki.",
      details_desktop: "Tafuta msimbopau (mfululizo wa mistari mieusi au msimbo mraba). Hakikisha lenzi za kamera yako ni safi na msimbopau uko kwenye mwanga wa kutosha.",
      title: "Tafuta na uskani msimbopau",
      title_desktop: "Safisha lenzi za kamera yako na utafute msimbopau",
    },
    btn: "Anza kuskani",
    document_with_barcode: {
      details: "Aina tofauti za hati zinaweza kuwa na miundo na sehemu tofauti ya msimbopau. Angalia upande wa mbele na nyuma wa hati ili uone msimbopau.",
      details_desktop: "Angalia upande wa mbele na nyuma wa hati ili uone msimbopau. Hakikisha lenzi za kamera yako ni safi na hati iko kwenye mwanga wa kutosha.",
      title: "Tafuta msimbopau kwenye hati",
      title_desktop: "Safisha lenzi za kamera yako na utafute msimbopau",
    },
    document_with_mrz: {
      details: "Utapata mfululizo mrefu wa herufi chini ya sehemu ya mbele au nyuma ya hati, uliogawanywa katika mistari 2 au 3 na kutenganishwa na mishale (<< au >>).",
      details_desktop: "Angalia upande wa mbele na nyuma wa hati ili uone MZR. Tafuta mistari 2–3 ya herufi na alama za kishale (<<) zilizo chini ya hati.Hakikisha lenzi za kamera yako ni safi na hati iko kwenye mwanga wa kutosha.",
      title: "Tafuta MRZ kwenye hati",
      title_desktop: "Safisha lenzi yako na utafute MRZ",
    },
    full_document: {
      details: "Hakikisha hati iko kwenye mwanga wa kutosha. Sehemu zote za hati zinapaswa kuonekana kwenye skrini ya kamera.",
  ...
  timeout_modal: {
    details: "Hakikisha hati ina mwanga wa kutosha, inaonekana vizuri, na haina mng'ao.",
    details_desktop: "Hakikisha lenzi za kamera yako ni safi na hati inaonekana kikamilifu, iko wazi na ina mwanga wa kutosha.",
