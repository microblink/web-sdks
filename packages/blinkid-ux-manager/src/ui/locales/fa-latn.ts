...
export default {
  ...
  document_filtered: "سند پذیرفته نشد",
  document_filtered_details: "سعی کنید سند دیگری را اسکن کنید.",
  ...
  help_modal_done_btn: "انجام شد",
  help_modal_next_btn: "بعدی",
  help_modal_title_1: "همه فیلدها را قابل مشاهده نگه دارید",
