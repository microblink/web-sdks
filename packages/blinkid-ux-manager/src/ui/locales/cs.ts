...
export default {
  ...
  feedback_messages: {
    ...
    face_photo_not_fully_visible: "Zajistěte, aby byla fotografie obličeje zcela viditelná",
    ...
    glare_detected: "Nakloňte nebo posuňte dokument, abyste odstranili odlesk",
    ...
    scan_the_front_side: "Naskenujte přední stranu dokumentu",
  ...
  help_modal: {
    ...
    barcode_only: {
      blur: {
        details: "Při skenování se snažte držet telefon a čárový kód v klidu. Pohyb může obraz rozmazat a způsobit, že čárový kód nebude čitelný.",
        details_desktop: "Při skenování se snažte nehýbat. Pohyb může obraz rozmazat a čárový kód pak může být obtížně čitelný.",
        title: "Při skenování se nehýbejte",
        title_desktop: "Při skenování se nehýbejte",
      },
      camera_lens: {
        details_desktop: "Zkontrolujte, zda na objektivu fotoaparátu nejsou šmouhy nebo prach. Špinavý objektiv způsobuje rozmazání výsledného obrazu, což znemožňuje přečtení čárového kódu a úspěšné naskenování dat.",
        title_desktop: "Vyčistěte objektiv fotoaparátu",
      },
      lighting: {
        details: "Vyhněte se přímému ostrému světlu, protože by mohlo způsobit odlesky na čárovém kódu a ztížit jeho naskenování. Pokud čárový kód dobře nevidíte, nemusí být dobře čitelný ani pro fotoaparát.",
        details_desktop: "Vyhněte se přímému ostrému světlu, protože by mohlo způsobit odlesky na čárovém kódu a ztížit jeho naskenování. Pokud čárový kód dobře nevidíte, nemusí být dobře čitelný ani pro fotoaparát.",
        title: "Dávejte pozor na ostré světlo",
        title_desktop: "Dávejte pozor na ostré světlo",
      },
      visibility: {
        details: "Zkontrolujte, zda část čárového kódu nezakrýváte prstem. Také dejte pozor na odlesky, které by mohly zapříčinit, že bude nečitelný.",
        details_desktop: "Zkontrolujte, zda část čárového kódu nezakrýváte prstem. Také dejte pozor na odlesky, které by mohly zapříčinit, že bude nečitelný.",
    ...
    document_with_mrz: {
      ...
      visibility: {
        details: "Zkontrolujte, zda část MRZ kódu nezakrýváte prstem. Také dejte pozor na odlesky, které by mohly zapříčinit, že bude nečitelný.",
        details_desktop: "Zkontrolujte, zda část MRZ kódu nezakrýváte prstem. Také dejte pozor na odlesky, které by mohly zapříčinit, že bude nečitelný.",
  ...
  onboarding_modal: {
    ...
    barcode_only: {
      details: "Najděte čárový kód (řadu černých čar nebo čtvercový kód). Nasměrujte na něj fotoaparát a nehýbejte s ním – skenování proběhne automaticky.",
      details_desktop: "Najděte čárový kód (řadu černých čar nebo čtvercový kód). Ujistěte se, že je objektiv fotoaparátu čistý a čárový kód je dobře osvětlený.",
      title: "Najděte a naskenujte čárový kód",
      title_desktop: "Vyčistěte objektiv a najděte čárový kód",
    },
    btn: "Spustit skenování",
    document_with_barcode: {
      details: "Různé typy dokumentů se mohou lišit formátem a umístěním čárového kódu. Kód může být jak na přední, tak na zadní straně dokumentu.",
      details_desktop: "Najděte čárový kód na přední nebo zadní straně dokumentu. Ujistěte se, že je objektiv fotoaparátu čistý a dokument je dobře osvětlený.",
      title: "Vyhledejte na dokumentu čárový kód",
      title_desktop: "Vyčistěte objektiv a najděte čárový kód",
    },
    document_with_mrz: {
      details: "Ve spodní části přední či zadní strany dokumentu najdete dlouhý řetězec znaků, který je rozdělený do 2 nebo 3 řádků a přerušovaný šipkami (<< nebo >>).",
      details_desktop: "Najděte MRZ kód na přední nebo zadní straně dokumentu. V dolní části dokumentu najděte 2–3 řádky znaků a symboly šipek (<<). Ujistěte se, že je objektiv fotoaparátu čistý a dokument je dobře osvětlený.",
      title: "Vyhledejte na dokumentu MRZ kód",
      title_desktop: "Vyčistěte objektiv a najděte MRZ kód",
    },
    full_document: {
      details: "Ujistěte se, že je dokument dobře osvětlen. Na obrazovce fotoaparátu by měla být vidět všechna pole dokumentu.",
  ...
  timeout_modal: {
    details: "Ujistěte se, že je dokument dobře osvětlený, zcela viditelný a bez odlesků.",
    details_desktop: "Ujistěte se, že je objektiv fotoaparátu čistý a že je dokument zcela viditelný, zaostřený a dobře osvětlený.",
