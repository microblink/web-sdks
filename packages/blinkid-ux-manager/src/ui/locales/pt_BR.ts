...
export default {
  ...
  error_modal: {
    cancel_btn: "Cancelar leitura",
    retry_btn: "Tentar novamente",
  },
  feedback_messages: {
    blur_detected: "Mantenha o documento e o celular parados",
    camera_angle_too_steep: "Mantenha o documento paralelo ao celular",
    ...
    scan_the_barcode_side: "Digitalize o lado do documento que contém o código de barras",
  ...
  help_modal: {
    ...
    barcode_only: {
      blur: {
        details: "Tente manter o celular e o código de barras imóveis durante a digitalização. Movimentos de qualquer um deles podem desfocar a imagem e dificultar a leitura do código de barras.",
        details_desktop: "Tente manter o celular imóvel durante a digitalização. Movimentos podem desfocar a imagem e dificultar a leitura do código de barras.",
        title: "Mantenha-se imóvel durante a digitalização",
        title_desktop: "Mantenha-se imóvel durante a digitalização",
      },
      camera_lens: {
        details_desktop: "Verifique se a lente da câmera está limpa e sem poeira. Uma lente suja faz com que a imagem final fique borrada, tornando o código de barras ilegível e impedindo a leitura correta dos dados.",
        title_desktop: "Limpe a lente da câmera",
      },
      lighting: {
        details: "Evite luzes fortes diretas, pois elas podem causar reflexos no código de barras e dificultar a digitalização. Se o código de barras não estiver claramente visível para você, a câmera provavelmente também não conseguirá lê-lo.",
        details_desktop: "Evite luzes fortes diretas, pois elas podem causar reflexos no código de barras e dificultar a digitalização. Se o código de barras não estiver claramente visível para você, a câmera provavelmente também não conseguirá lê-lo.",
        title: "Cuidado com a luz forte",
        title_desktop: "Cuidado com a luz forte",
      },
      visibility: {
        details: "Certifique-se de não cobrir partes do código de barras com os dedos. Além disso, fique atento a reflexos sobre o código de barras, pois eles podem torná-lo ilegível.",
        details_desktop: "Certifique-se de não cobrir partes do código de barras com os dedos. Além disso, fique atento a reflexos sobre o código de barras, pois eles podem torná-lo ilegível.",
    ...
    document_with_mrz: {
      ...
      visibility: {
        details: "Certifique-se de não cobrir nenhuma parte da MRZ com os dedos. Além disso, evite reflexos sobre a MRZ, pois eles podem torná-la ilegível.",
        details_desktop: "Certifique-se de não cobrir nenhuma parte da MRZ com os dedos. Além disso, evite reflexos sobre a MRZ, pois eles podem torná-la ilegível.",
  ...
  onboarding_modal: {
    ...
    barcode_only: {
      details: "Procure um código de barras (uma sequência de linhas pretas ou um código quadrado). Aponte a câmera para ele e mantenha o celular imóvel — a digitalização acontecerá automaticamente.",
      details_desktop: "Procure um código de barras (uma sequência de linhas pretas ou um código quadrado). Certifique-se de manter a lente da câmera limpa e o código de barras bem iluminado.",
    ...
    document_with_barcode: {
      details: "Diferentes tipos de documentos podem ter formatos e localizações de código de barras diferentes. Verifique a frente e o verso do documento em busca de um código de barras.",
      details_desktop: "Verifique a frente e o verso do documento em busca de um código de barras. Certifique-se de manter a lente da câmera limpa e o documento bem iluminado.",
      title: "Localize o código de barras no documento",
      title_desktop: "Limpe a lente da câmera e localize o código de barras",
    },
    document_with_mrz: {
      details: "Você encontrará uma longa sequência de caracteres na parte inferior da frente ou do verso do documento, dividida em 2 ou 3 linhas e separada por símbolos de seta (<< ou >>).",
      details_desktop: "Verifique a frente e o verso do documento em busca da MRZ. Procure por 2 ou 3 linhas de caracteres e símbolos de seta (<<) na parte inferior do documento. Certifique-se de manter a lente da câmera limpa e o documento bem iluminado.",
      title: "Localize a MRZ no documento",
      title_desktop: "Limpe a lente da câmera e localize a MRZ.",
    },
    full_document: {
      details: "Certifique-se de manter o documento bem iluminado. Todos os campos do documento devem estar visíveis na tela da câmera.",
  ...
  timeout_modal: {
    details: "Certifique-se de que o documento esteja bem iluminado, totalmente visível e sem reflexos.",
    details_desktop: "Certifique-se de que a lente da câmera esteja limpa e que o documento esteja totalmente visível, em foco e bem iluminado.",
