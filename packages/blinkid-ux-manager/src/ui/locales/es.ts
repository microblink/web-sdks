...
export default {
  ...
  feedback_messages: {
    blur_detected: "Mantén el documento y el teléfono quietos",
    camera_angle_too_steep: "Mantén el documento paralelo al teléfono",
    document_scanned_aria: "¡Bien! Documento escaneado",
    document_too_close_to_edge: "Alejarse",
    face_photo_not_fully_visible: "Mantén la foto del rostro completamente visible",
    flip_document: "Dar la vuelta al documento",
    flip_to_back_side: "Dele la vuelta al documento",
    front_side_scanned_aria: "¡Anverso escaneado!",
    glare_detected: "Inclina o mueve el documento para eliminar el reflejo",
    ...
    scan_the_back_side: "Escanee el reverso de un documento",
    scan_the_barcode: "Escanea el código de barras",
    scan_the_barcode_side: "Escanea el reverso del documento con el código de barras",
    scan_the_front_side: "Escanee el anverso de un documento",
  ...
  help_modal: {
    ...
    barcode_only: {
      blur: {
        details: "Intenta mantener el teléfono y el código de barras estables mientras escaneas. Si se mueve alguno de los dos, la imagen puede salir borrosa y el código de barras podría no leerse correctamente.",
        details_desktop: "Intenta no mover el documento mientras escaneas. Si se mueve, la imagen puede salir borrosa y el código de barras podría no leerse correctamente.",
        title: "No se mueva mientras escanea",
        title_desktop: "No se mueva mientras escanea",
      },
      camera_lens: {
        details_desktop: "Revisa que no haya manchas ni polvo en la lente de la cámara. Si está sucia, la imagen puede salir borrosa, lo que puede impedir que el código de barras se lea correctamente y que se escanee la información.",
        title_desktop: "Limpia la lente de la cámara",
      },
      lighting: {
        details: "Evita la luz directa fuerte, ya que puede generar reflejos en el código de barras y dificultar el escaneo. Si no ves el código de barras con claridad, es posible que la cámara tampoco pueda leerlo.",
        details_desktop: "Evita la luz directa fuerte, ya que puede generar reflejos en el código de barras y dificultar el escaneo. Si no ves el código de barras con claridad, es posible que la cámara tampoco pueda leerlo.",
        title: "Cuidado con la luz intensa",
        title_desktop: "Cuidado con la luz intensa",
      },
      visibility: {
        details: "Asegúrate de no cubrir partes del código de barras con el dedo. También ten cuidado con los reflejos que puedan cubrirlo y hacerlo ilegible.",
        details_desktop: "Asegúrate de no cubrir partes del código de barras con el dedo. También ten cuidado con los reflejos que puedan cubrirlo y hacerlo ilegible.",
    ...
    document_with_mrz: {
      ...
      visibility: {
        details: "Asegúrate de no cubrir partes del MRZ con el dedo. También ten cuidado con los reflejos que puedan cubrirlo y hacerlo ilegible.",
        details_desktop: "Asegúrate de no cubrir partes del MRZ con el dedo. También ten cuidado con los reflejos que puedan cubrirlo y hacerlo ilegible.",
  ...
  onboarding_modal: {
    ...
    barcode_only: {
      details: "Busca un código de barras (una serie de líneas negras o un código cuadrado). Apunta con la cámara hacia él y no muevas el teléfono: el escaneo se realizará automáticamente.",
      details_desktop: "Busca un código de barras (una serie de líneas negras o un código cuadrado). Asegúrate de que la lente de la cámara esté limpia y de que el código de barras esté bien iluminado.",
      title: "Busca y escanea el código de barras",
      title_desktop: "Limpia la lente y busca el código de barras",
    },
    btn: "Empezar a escanear",
    document_with_barcode: {
      details: "Cada tipo de documento puede tener un formato y una ubicación del código de barras diferente. Busca el código de barras tanto en la parte frontal como en el reverso del documento.",
      details_desktop: "Comprueba el anverso y el reverso del documento en busca de un código de barras. Asegúrate de que la lente de la cámara esté limpia y de que el documento esté bien iluminado.",
      title: "Localiza el código de barras en el documento",
      title_desktop: "Limpia la lente y busca el código de barras",
    },
    document_with_mrz: {
      details: "En la parte inferior de la parte frontal o del reverso del documento encontrarás una larga cadena de caracteres dividida en 2 o 3 líneas y separada por flechas (<< o >>).",
      details_desktop: "Comprueba si hay un MRZ en el anverso y el reverso del documento. Busca entre 2 y 3 líneas de caracteres y símbolos de flecha (<<) en la parte inferior del documento. Asegúrate de que la lente de la cámara esté limpia y de que el documento esté bien iluminado.",
      title: "Localiza el MRZ en el documento",
      title_desktop: "Limpia la lente y busca el MRZ",
    },
    full_document: {
      details: "Asegúrese de mantener el documento bien iluminado. Todos los campos del documento deben ser visibles en la pantalla de la cámara.",
  ...
  timeout_modal: {
    details: "Asegúrate de que el documento esté bien iluminado, se vea completamente y no haya reflejos.",
    details_desktop: "Asegúrate de que la lente de la cámara esté limpia y de que el documento se vea completamente, esté enfocado y bien iluminado.",
