...
export default {
  ...
  error_modal: {
    cancel_btn: "Soke dubawa",
    retry_btn: "Sake gwadawa",
  },
  feedback_messages: {
    blur_detected: "Riƙe takardar da wayar ba tare da motsi ba",
    camera_angle_too_steep: "Riƙe takardar a layi ɗaya da wayar",
    document_scanned_aria: "An yi nasara! An ɗauki hoton takarda",
    document_too_close_to_edge: "Matsa baya",
    face_photo_not_fully_visible: "Tabbatar hoton fuskar yana bayyane gaba ɗaya",
    ...
    glare_detected: "Karkatar ko matsar da takardar don cire haske mai kyalli",
    keep_document_parallel: "Riƙe takardar a layi ɗaya da allon",
    ...
    scan_the_barcode_side: "A ɗauki hoton ɓangaren takardar da ke ɗauke da barcode",
  ...
  help_modal: {
    ...
    barcode_only: {
      blur: {
        details: "A daina jijjiga wayar da barcode ɗin yayin da ake ɗaukar hoto. Motsawa zai sa hoton ya yi dishi-dishi sannan zai sa barcode ɗin ya yi wahalar karantawa.",
        details_desktop: "A daina jijjigawa yayin da ake ɗaukar hoto. Motsawa zai sa hoton ya yi dishi-dishi sannan zai sa barcode ɗin ya yi wahalar karantawa.",
        title: "Kada a motsa yayin ɗaukar hoto",
        title_desktop: "Kada a motsa yayin ɗaukar hoto",
      },
      camera_lens: {
        details_desktop: "A duba domin tabbatar da gilashin kamerarku bai yi dishi-dishi ba, kuma ba ya ɗauke da ƙura. Gilashin kamera mai datti yakan sa hoton ya yi bishi-bishi, wanda hakan zai sa ba za a iya karanta barcode ɗin ba sannan zai hana a ɗauki hoton bayanna yadda ya kamata.",
        title_desktop: "Ku tsaftace gilashin kamerarku",
      },
      lighting: {
        details: "Kada a yi amfani da haske mai ƙarfi kai tsaye domin zai yi dau a kan barcode ɗin sannan zai sa ɗaukar hoton ya yi wahala. Idan ba kwa kallon barcode ɗin yadda ya kamata, to ba dole ba ne kamerarku ma ta iya karanta shi.",
        details_desktop: "Kada a yi amfani da haske mai ƙarfi kai tsaye domin zai yi dau a kan barcode ɗin sannan zai sa ɗaukar hoton ya yi wahala. Idan ba kwa kallon barcode ɗin yadda ya kamata, to ba dole ba ne kamerarku ma ta iya karanta shi.",
        title: "A duba haske mai ƙarfi",
        title_desktop: "A duba haske mai ƙarfi",
      },
      visibility: {
        details: "A tabbatar da cewa ba a rufe wasu ɓangarorin barcode ɗin ba da yatsa. Bayan haka, a duba ko akwai wani dau na haske da ya hau kan barcode ɗin wanda kuma zai iya sa ba zai karantu ba.",
        details_desktop: "A tabbatar da cewa ba a rufe wasu ɓangarorin barcode ɗin ba da yatsa. Bayan haka, a duba ko akwai wani dau na haske da ya hau kan barcode ɗin wanda kuma zai iya sa ba zai karantu ba.",
    ...
    document_with_mrz: {
      ...
      visibility: {
        details: "A tabbatar da cewa ba a rufe wasu ɓangarorin MRZ da yatsa ba. Bayan haka, a duba ko akwai wani dau na haske da ya hau kan MRZ ɗin wanda zai iya sa ba zai karantu ba.",
        details_desktop: "A tabbatar da cewa ba a rufe wasu ɓangarorin MRZ da yatsa ba. Bayan haka, a duba ko akwai wani dau na haske da ya hau kan MRZ ɗin wanda zai iya sa ba zai karantu ba.",
  ...
  onboarding_modal: {
    ...
    barcode_only: {
      details: "A duba barcode (jerin baƙaƙen layuka ko baƙin zane da yake cikin tsarin akwati). Ku saita shi da kamerarku sannan ku tsaya tsam ba tare da jijjigawa ba — hoton zai ɗauku da kansa.",
      details_desktop: "A duba barcode (jerin baƙaƙen layuka ko baƙin zane da yake cikin tsarin akwati). Ku tabbatar da cewa babu datti a kan gilashin kamerarku sannan a haska barcode ɗin yadda ya kamata.",
    ...
    document_with_barcode: {
      details: "Takardu mabambanta suna iya zuwa da tsarin barcode mabambanta sanan da wuri daban-daban. A duba gaba da bayan takardar don barcode ɗin.",
      details_desktop: "Duba gaba da bayan takardar don barcode. Tabbatar ka ajiye gilashin kemararku cikin tsabta kuma an haska takardar da kyau.",
      title: "Nemi barcode akan takardar",
      title_desktop: "Ku tsaftace gilashin kamerarku sannan ku dubo barcode",
    },
    document_with_mrz: {
      details: "Za ka nemi dogon jerin haruffa a kasa a gaba ko bayan takardar, raba shi zuwa layuka 2 ko 3 kuma a raba da kibiyoyi (<< ko >>).",
      details_desktop: "A duba gaba da bayan takarda don MRZ. Nemi layuka 2-3 na haruffa da alomomin kibiyoyi (<<) a kasan takardar. Ku tabbatar da cewa kun ajiye gilashin kamerarku cikin tsabta sannan a haska takardar yadda ya kamata.",
      title: "Nemi MRZ akan takardar",
      title_desktop: "Goge gilashinku kuma ku nemi MRZ",
    },
    full_document: {
      details: "A tabbatar da an haska ɗaukacin takardar. Ya kasance ana ganin dukkannin ɓangarorin takardar a cikin sikirin ɗin kamera.",
  ...
  timeout_modal: {
    details: "Tabbatar cewa an haska takardar da kyau, ana gani cikakke, kuma ba wani dishi-dishi.",
    details_desktop: "Tabbatar cewa gilashin kamerarku yana da tsabta kuma ana ganin takardar gabaɗaya, cikin kula, kuma an haska shi da kyau.",
