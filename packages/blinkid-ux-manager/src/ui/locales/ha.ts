...
export default {
  ...
  document_filtered: "Ba a karɓi takarda ba",
  document_filtered_details: "Gwada ɗaukar hoton wata takarda ta daban.",
  ...
  help_modal_done_btn: "Kammala",
  help_modal_next_btn: "Gaba",
  help_modal_title_1: "A daidaita yadda za a riƙa ganin dukkannin ɓangarori",
