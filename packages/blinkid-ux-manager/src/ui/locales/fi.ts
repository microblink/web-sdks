...
export default {
  ...
  feedback_messages: {
    ...
    camera_angle_too_steep: "Pidä asiakirja puhelimen suuntaisesti",
    document_scanned_aria: "Onnistui! Asiakirja skannattu",
    document_too_close_to_edge: "Siirry kauemmas",
    face_photo_not_fully_visible: "Pidä kasvokuva kokonaan näkyvissä",
    ...
    keep_document_parallel: "Pidä asiakirja näytön suuntaisesti",
    ...
    scan_the_back_side: "Skannaa asiakirjan kääntöpuoli",
  ...
  help_modal: {
    ...
    barcode_only: {
      blur: {
        details: "Yritä pitää puhelin ja viivakoodi paikallaan skannauksen aikana. Jommankumman liikuttaminen voi sumentaa kuvaa ja vaikeuttaa viivakoodin lukemista.",
        details_desktop: "Yritä pysyä liikkumatta skannauksen aikana. Liikkuminen voi sumentaa kuvaa ja vaikeuttaa viivakoodin lukemista.",
        title: "Pysy paikallasi skannauksen aikana",
        title_desktop: "Pysy paikallasi skannauksen aikana",
      },
      camera_lens: {
        details_desktop: "Tarkista kameran linssi tahrojen tai pölyn varalta. Likainen linssi voi sumentaa lopullista kuvaa, jolloin viivakoodi ei ole luettavissa ja tietojen skannaus ei onnistu.",
        title_desktop: "Puhdista kameran linssi",
      },
      lighting: {
        details: "Vältä suoraa voimakasta valoa, koska se voi heijastua viivakoodista ja vaikeuttaa skannausta. Jos et näe viivakoodia selvästi, myöskään kamerasi ei pysty välttämättä lukemaan sitä.",
        details_desktop: "Vältä suoraa voimakasta valoa, koska se voi heijastua viivakoodista ja vaikeuttaa skannausta. Jos et näe viivakoodia selvästi, myöskään kamerasi ei pysty välttämättä lukemaan sitä.",
        title: "Varo voimakasta valoa",
        title_desktop: "Varo voimakasta valoa",
      },
      visibility: {
        details: "Varmista, ettet peitä viivakoodia sormella. Varo myös, ettei viivakoodin päälle synny heijastuksia, jotka tekisivät siitä lukukelvottoman.",
        details_desktop: "Varmista, ettet peitä viivakoodia sormella. Varo myös, ettei viivakoodin päälle synny heijastuksia, jotka tekisivät siitä lukukelvottoman.",
    ...
    document_with_mrz: {
      ...
      visibility: {
        details: "Varmista, ettet peitä mitään MRZ-alueen osaa sormella. Kiinnitä lisäksi huomiota MRZ-alueella oleviin heijastuksiin, jotka voisivat estää sen lukemisen.",
        details_desktop: "Varmista, ettet peitä mitään MRZ-alueen osaa sormella. Kiinnitä lisäksi huomiota MRZ-alueella oleviin heijastuksiin, jotka voisivat estää sen lukemisen.",
  ...
  onboarding_modal: {
    aria: "Skannausohjeet",
    barcode_only: {
      details: "Etsi viivakoodi (sarja mustia viivoja tai neliönmuotoinen koodi). Osoita kamerasi sitä kohti ja pysy liikkumatta – skannaus tapahtuu automaattisesti.",
      details_desktop: "Etsi viivakoodi (sarja mustia viivoja tai neliönmuotoinen koodi). Varmista, että kameran linssi on puhdas ja viivakoodi hyvin valaistu.",
      title: "Etsi ja skannaa viivakoodi",
      title_desktop: "Puhdsta linssi ja etsi viivakoodi",
    },
    btn: "Aloita skannaus",
    document_with_barcode: {
      details: "Erityyppisten asiakirjojen viivakoodin muoto ja sijainti saattavat vaihdella. Etsi viivakoodi tarkistamalla asiakirjan etu- ja kääntöpuoli.",
      details_desktop: "Etsi viivakoodi tarkistamalla asiakirjan etu- ja kääntöpuoli. Varmista, että kameran linssi on puhdas ja asiakirja on hyvin valaistu.",
      title: "Etsi asiakirjan viivakoodi",
      title_desktop: "Puhdsta linssi ja etsi viivakoodi",
    },
    document_with_mrz: {
      details: "Löydät asiakirjan etu- tai kääntöpuolen alareunasta pitkän merkkijonon, joka on jaettu 2 tai 3 riville ja jonka osat on erotettu toisistaan nuolilla (<< tai >>).",
      details_desktop: "Etsi MRZ tarkistamalla asiakirjan etu- ja kääntöpuoli. MRZ on asiakirjan alareunassa oleva alue, jolla on 2–3 riviä merkkejä ja nuolisymboleja (<<). Varmista, että kameran linssi on puhdas ja asiakirja on hyvin valaistu.",
      title: "Etsi asiakirjan MRZ",
      title_desktop: "Puhdista linssi ja etsi MRZ",
    },
    full_document: {
      details: "Varmista, että asiakirja on hyvin valaistu. Kaikkien asiakirjan kenttien tulee näkyä kameran näytöllä.",
  ...
  timeout_modal: {
    details: "Varmista, että asiakirja on hyvin valaistu, se näkyy kokonaisuudessaan eikä siinä ole heijastuksia.",
    details_desktop: "Varmista, että kameran linssi on puhdas ja että asiakirja näkyy kokonaisuudessaan, se on hyvin valaistu ja tarkennus on terävä.",
