...
import { blinkIdUiStateMap } from "../core/blinkid-ui-state";
...
const TestFeedbackUi: Component<{
  ...
  <LocalizationProvider userStrings={props.localization}>
    <UiFeedbackOverlay uiState={blinkIdUiStateMap.INTRO_FRONT_PAGE} isDesktop={false} />
    <UiFeedbackOverlay uiState={blinkIdUiStateMap.DOCUMENT_FRAMING_CAMERA_TOO_FAR} isDesktop={false} />
