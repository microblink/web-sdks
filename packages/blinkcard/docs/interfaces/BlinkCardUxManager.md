...
[@microblink/blinkcard](../README.md) / BlinkCardUxManager
...
> **deviceInfo**: [`DeviceInfo`](../type-aliases/DeviceInfo.md)
...
> **sessionSettings**: [`BlinkCardSessionSettings`](../type-aliases/BlinkCardSessionSettings.md)
...
> **getSessionResult**(): `Promise`\<[`BlinkCardScanningResult`](../type-aliases/BlinkCardScanningResult.md)\>

Gets the result from the scanning session.

#### Returns

`Promise`\<[`BlinkCardScanningResult`](../type-aliases/BlinkCardScanningResult.md)\>
