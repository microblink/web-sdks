...
/**
 * Downloads a resource buffer.
 *
 * @param url - The URL of the resource to download.
 * @param resourceFileType - The file type of the resource.
 * @param wasmVariant - The Wasm variant.
...
export async function downloadResourceBuffer(
  ...
  const contentLength = contentLengthHeader
    ...
    : getWasmFileSize(resourceFileType, wasmVariant);
