...
[@microblink/blinkid-verify](../README.md) / BlinkIdVerifyUxManager
...
> `readonly` **sessionSettings**: [`BlinkIdVerifySessionSettings`](../type-aliases/BlinkIdVerifySessionSettings.md)
