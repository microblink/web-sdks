...
> **country**: [`DocumentClassCountry`](DocumentClassCountry.md) \| `undefined`
...
> **documentType**: [`DocumentClassDocumentType`](DocumentClassDocumentType.md) \| `undefined`
...
> **region**: [`DocumentClassRegion`](DocumentClassRegion.md) \| `undefined`
