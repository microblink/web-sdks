...
[@microblink/blinkid-verify-core](../README.md) / BlinkIdVerifyWorkerInitSettings

# Type Alias: BlinkIdVerifyWorkerInitSettings

> **BlinkIdVerifyWorkerInitSettings** = `object`
...
> `optional` **wasmVariant**: [`WasmSimdVariant`](WasmSimdVariant.md)
