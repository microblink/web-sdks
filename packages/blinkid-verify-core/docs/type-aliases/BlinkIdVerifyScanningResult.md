...
[@microblink/blinkid-verify-core](../README.md) / BlinkIdVerifyScanningResult
...
Represents the final result of scanning both sides of the document. It potentially contains the captured frames for
the front, back, and barcode.
