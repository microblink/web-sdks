...
export const feedbackMessages: Partial<
  Record<BlinkCardUiStateKey, (isDesktop?: boolean) => keyof LocalizationStrings["feedback_messages"]>
> = {
  ...
  BLUR_DETECTED: (isDesktop?: boolean) => (isDesktop ? "blur_detected_desktop" : "blur_detected"),
};
