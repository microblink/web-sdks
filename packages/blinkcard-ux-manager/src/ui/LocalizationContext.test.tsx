...
const TestFeedbackUi: Component<{
  ...
  <LocalizationProvider userStrings={props.localization}>
    <UiFeedbackOverlay uiState={blinkCardUiStateMap.INTRO_FRONT} isDesktop={false} />
    <UiFeedbackOverlay uiState={blinkCardUiStateMap.CARD_FRAMING_CAMERA_TOO_FAR} isDesktop={false} />
