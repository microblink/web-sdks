 ...
 *
 * Use this for fine-grained, step-by-step assertions where you want to control intermediate timing transitions
 * explicitly.
 */
 ...
 *
 * Use this after an interaction when you only care that the next UI RAF cycle has been applied, not the exact
 * intermediate timing.
 */
 ...
 *
 * Use this for integration-style flow steps that need both: 1) advancing clock time (e.g. minDuration windows), and 2)
 * applying resulting RAF-driven UI updates.
 */
