...
/**
 * Gets the cross-origin worker URL. If same origin, the original worker URL is returned. Otherwise, the worker is
 * fetched and converted to a blob or data URL.
 *
