...
/**
 * A custom render function that allows you to specify the owner of the rendered component. This is useful when you want
 * to render a component into a different owner than the current one.
 *
 ...
 */
export const renderWithOwner = (code: () => JSX.Element, element: MountableElement, owner: Owner | null) => {
