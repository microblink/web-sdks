...
/**
 * Gets the key associated with the highest numeric value in an object. Throws an error if the object is empty.
 *
 ...
 */
export function getKeyWithHighestValue<TObj extends Record<string, number>>(obj: TObj): keyof TObj {
