# BlinkID UI Overrides Example

This example demonstrates how to retain BlinkID's provided scanning interface while disabling or replacing selected UI flows. It turns off built-in onboarding, help, and error dialogs, then provides custom implementations for the error states that require application handling.
