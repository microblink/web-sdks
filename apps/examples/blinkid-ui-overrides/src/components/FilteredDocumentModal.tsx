...
/**
 * Modal component for displaying filtered document errors when a document passes BlinkID validation but fails custom
 * business logic filters.
 */
export const FilteredDocumentModal: Component<FilteredDocumentModalProps> = (props) => {
  return (
    <Modal
      open={props.open}
