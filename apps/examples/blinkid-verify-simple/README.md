# BlinkID Verify Simple Example

This example application provides a minimal demonstration of how to integrate and use the BlinkID Verify SDK in a web application. It showcases the simplest way to get started with document scanning.
...
- **High-Level API**: Shows the usage of the `createBlinkIdVerify` high-level function, which simplifies the integration process by abstracting away the underlying complexities.
